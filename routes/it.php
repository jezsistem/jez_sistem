...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('menu-access-templates')->group(function () {
        ...
        Route::prefix('details')->group(function () {
            Route::post('/store', [MenuAccessTemplateDetailController::class, 'store'])->name('menu.access.template.details.store');
            Route::delete('/delete/{id}', [MenuAccessTemplateDetailController::class, 'destroy'])->name('menu.access.template.details.destroy');
        });
    });
});
