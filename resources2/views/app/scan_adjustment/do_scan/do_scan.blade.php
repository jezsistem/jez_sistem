                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header flex-wrap py-3 row">
                            ...
                            <div class="card-toolbar col-6 ">
                                ...
                                <!--end::Button-->
                                <!--begin::Button-->
                                <a href="#" class="btn btn-success font-weight-bolder" id="scanned_qty"></a>
                                <!--end::Button-->
                            </div>
                        </div>
                            ...
                            <table class="table table-hover table-checkable" id="SAtb">
                                <thead class="bg-primary text-light">
                                    <tr>
                                        ...
                                        <th class="text-light"><input class="form-control" type="text" id="search_article" value="" placeholder="cari artikel pada list ..."/></th>
                                        <th class="text-light">@if($data['sa_status'] != 1)<a class="btn btn-sm btn-info" id="sync_btn">Sync</a> <a class="btn btn-sm btn-danger" id="reset_btn">Reset</a>@endif</th>
                                    </tr>
                                </thead>
                                <tbody>
