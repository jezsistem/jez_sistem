    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary font-weight-bold" id="save_scan_adjustment_btn">Simpan</button>
            </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header" style='background:#007bff;'>
                <h5 class="modal-title text-light" id="exampleModalLabel">Sub Kategori</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
                ...
                <table class="table table-hover table-checkable" id="Smtb">
                    <thead class="bg-primary text-light">
                        <tr>
                            <th class="text-light">No</th>
                            <th class="text-light">Brand</th>
                            <th class="text-light">Qty Sebelum</th>
                            <th class="text-light">Qty Sesudah</th>
                            <th class="text-light">Value Sebelum</th>
                            <th class="text-light">Value Sesudah</th>
                        </tr>
                    </thead>
                    <tbody>
