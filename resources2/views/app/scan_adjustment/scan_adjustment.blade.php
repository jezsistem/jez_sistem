                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header flex-wrap py-3">
                            <div class="card-toolbar">
                                <!--begin::Button-->
                                <a href="#" class="btn btn-primary font-weight-bolder" id="add_scan_adjustment_btn">
                        ...
                        <div class="card-body table-responsive">
                            <!--begin: Datatable-->
                            <input type="search" class="form-control form-control-sm col-6" id="scan_adjustment_search" placeholder="Cari kode"/><br/>
                            <table class="table table-hover table-checkable" id="SAtb">
                                <thead class="bg-primary text-light">
                                    <tr>
                                        ...
                                        <th class="text-light">Eksekusi</th>
...
<!--end::Content-->
@include('app.scan_adjustment.scan_adjustment_modal')
@include('app._partials.js')
@include('app.scan_adjustment.scan_adjustment_js')
@endSection()
