                ...
                <div class="col-lg-12 col-xxl-12">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-body table-responsive">
                            <!--begin: Datatable-->
                            <input type="search" class="form-control form-control-sm col-6" id="wr_search" placeholder="Cari nama .."/><br/>
...
@include('app.web_reminder.web_reminder_js')
@endSection()