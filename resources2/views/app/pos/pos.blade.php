							...
							<div class="card-body">
								<div class="d-flex justify-content-between colorfull-select">
									...
									<div class="selectmain bg-primary" style="padding:5px; border-radius:10px;">
										...
										<input type="search" id="cust_id_label" placeholder="Ketik minimal 4 huruf customer" autocomplete="off"/> <a href="#" class="btn-sm btn-inventory" data-id="" id="check_customer">Check</a>
										<div id="itemListCust"></div><br/>
										<label class="text-white d-flex font-weight-bold" >Sub Customer (isi jika dropshipper)</label>
										<input type="search" id="sub_cust_id_label" placeholder="Ketik minimal 4 huruf sub customer" autocomplete="off"/> <a href="#" class="btn-sm btn-inventory" data-id="" id="check_sub_customer">Check</a>
									...
									<div class="selectmain">
										<label class="btn-sm btn-inventory col-12 rounded text-white d-flex font-weight-bold">Store</label>
