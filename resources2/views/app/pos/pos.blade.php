                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between colorfull-select">
                                    ...
                                    <div class="selectmain bg-primary" style="padding:5px; border-radius:10px;">
                                        ...
                                        <a href="#" class="btn btn-inventory" data-id=""
                                    ...
                                    <div class="selectmain">
                                        <label
                                            class="btn-sm btn-primary col-12 rounded text-white d-flex font-weight-bold">Refund
                                            / Penukaran</label>
                                        <input type="search" id="refund_invoice_label"
                                            placeholder="Ketik minimal 6 huruf invoice" />
                                        <div id="itemListRefund"></div><br />
                                        <span class="bg-danger d-none font-weight-bold text-white"
                                            id="complaint_info">Anda memiliki transaksi refund yang belum diselesaikan
                                            dengan invoice berikut &nbsp;<br /><span
                                                id="complaint_invoice"></span>&nbsp;<br />silahkan pilih kembali invoice
                                            pada list kemudian uncheck apabila tidak jadi</span>
                                    </div>
                                    <div class="selectmain">
                                        <label
                                            class="btn-sm btn-inventory col-12 rounded text-white d-flex font-weight-bold">Store</label>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <fieldset class="form-group mb-0 d-flex barcodeselection">
                                            ...
                                            <input style="background:#fef6df; color:black;" type="text"
                                                class="form-control border-dark col-8 mr-2" id="product_name_input"
                            ...
                            <div class="table-datapos">
                                ...
                                <div id="voucher_information" class='d-none'>
                                    <table id="orderTable" class="display table table-hover" style="width:100%">
                                        ...
                                        <thead class="bg-primary">
                                            <tr class="d-flex align-items-center justify-content-between pl-3 pr-3"
                                            ...
                                            <tr class="d-flex align-items-center justify-content-between pl-3 pr-3"
                                                ...
                                                <th class="col-6">
                                                    <span id="_voc_disc"></span> <span id="_voc_disc_type"></span>
                                                    <span id="_voc_disc_value"></span>
                                                </th>
                                            </tr>
                                            <tr class="d-flex align-items-center justify-content-between pl-3 pr-3"
                                                style="background:#fef6df;">
