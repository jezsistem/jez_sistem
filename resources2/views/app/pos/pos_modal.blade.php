                ...
                <form id="f_customer">
                    ...
                    <script>
                        document.getElementById('cust_phone').addEventListener('focus', function(e) {
                            if (e.target.value === '') {
                                e.target.value = '+62'; // Mengisi awalan +62 secara otomatis jika field kosong
                            }
                        });
                        ...
                        document.getElementById('cust_phone').addEventListener('input', function(e) {
                            ...
                            if (!phoneNumber.startsWith('+62')) {
                                e.target.value = '+62'; // Memastikan awalan selalu +62
                            }
                        });
                    </script>
                    </div>
                    ...
                    <tbody>
                        <tr class="d-flex align-items-center justify-content-between">
                            ...
                            <td
                                ...
                                <input type="text" placeholder="INVxxxxx" id="order_code"
