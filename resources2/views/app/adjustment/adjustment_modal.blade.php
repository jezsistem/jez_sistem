    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-light" id="exampleModalLabel">Adjustment [<span id="adjustment_label"></span>]</h5>
            ...
            <div class="modal-body">
                ...
                <div class="card-body table-responsive">
                    <input type="search" class="form-control form-control-sm col-6" id="article_search" placeholder="Cari nama artikel / warna / brand"/>
                    <table class="table table-hover table-checkable" id="Articletb">
                        <thead class="bg-primary text-light">
                            <tr>
                                <th class="text-light">No</th>
                                <th class="text-light">Article</th>
                                <th class="text-light">Size Stock Barcode</th>
                                <th class="text-light" style="white-space: nowrap;">Qty SO</th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary font-weight-bold" id="save_adjustment_btn">Simpan</button>
            </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="AddArticleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false" style="overflow-y: auto;">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-light-primary font-weight-bold" data-dismiss="modal">Tutup</button>
                <button type="submit" class="btn btn-primary font-weight-bold" id="save_add_article_btn">Simpan</button>
            </div>
            </form>
        </div>
    </div>
