                ...
                <div class="col-lg-12 col-xxl-12">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body table-responsive">
                            <!--begin: Datatable-->
                            <input type="search" class="form-control form-control-sm col-6" id="stock_transfer_search" placeholder="Cari user / artikel"/><br/>
                ...
                <div class="col-lg-12 col-xxl-12">
                    <div class="card card-custom gutter-b">
                        <div class="card-body table-responsive">
                            ...
                            <input type="search" class="form-control form-control-sm col-6" id="history_search" placeholder="Cari kode / artikel"/><br/>
                            <table class="table table-hover table-checkable" id="Historytb">
                                <thead class="bg-primary text-light">
                                    <tr>
                                        <th class="text-light">No</th>
                                        <th class="text-light">Kode</th>
                                        <th class="text-light">Store Awal</th>
                                        <th class="text-light">Store Tujuan</th>
