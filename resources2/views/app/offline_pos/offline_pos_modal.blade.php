                    ...
                    <script>
                        ...
                        document.getElementById('cust_phone').addEventListener('input', function(e) {
                            ...
                            if (!phoneNumber.startsWith('08')) {
                                e.target.value = '08' + phoneNumber.replace(/[^0-9]/g, '').substring(
                                2); // Hapus karakter non-numerik dan pastikan tetap 08 di awal
                            }
                        });
                    </script>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body bg-white">
                    ...
                    <tbody>
                        <tr class="d-flex align-items-center justify-content-between">
                            <th class="border-0 px-0 font-size-lg mb-0 font-size-bold text-primary">
                                <span class="btn-sm btn-inventory">Total Bayar</span>
                            </th>
                            <td
                        ...
                        <tr class="d-flex align-items-center justify-content-between" id="payment_type_content">
                            <th class="border-0 px-0 font-size-lg mb-0 font-size-bold text-primary">
                                <span class="btn-sm btn-inventory">Metode Pembayaran</span>
                            </th>
                            <td
                        ...
                        <tr class="d-flex align-items-center justify-content-between" id="charge_label">
                            ...
                            <td
                                class="border-0 justify-content-end d-flex text-primary font-size-lg font-size-bold px-0 font-size-lg mb-0 font-size-bold text-primary">
                                <input class="bg-light-primary" type="number" placeholder="" id="charge_total"
                                    readonly />
                            </td>
                        </tr>
                        ...
                        <tr class="d-flex align-items-center justify-content-between" id="card_number_label_two">
                            ...
                            <td
                                class="border-0 justify-content-end d-flex text-primary font-size-lg font-size-bold px-0 font-size-lg mb-0 font-size-bold text-primary">
                                <input class="bg-light-primary" type="text" placeholder=""
                                    id="card_number_two" />
                            </td>
                        </tr>
                        ...
                        <div id="online_mode">
                            ...
                            <tr class="d-flex align-items-center justify-content-between">
                                ...
                                <td
                                    class="border-0 justify-content-end d-flex text-primary font-size-lg font-size-bold px-0 font-size-lg mb-0 font-size-bold text-primary">
                                    <input type="number" placeholder="Ongkos Kirim (isi jika online)"
                                        id="shipping_cost" class="bg-light-primary" />
                                </td>
                            </tr>
                        </div>
                    </tbody>
                ...
                <div class="form-group row" id="total_payment_label">
                    <div class="col-md-6">
                        <label class="text-body"><span class="btn-sm btn-primary font-size-bold">Jumlah yang dibayar
                                Customer</span></label>
                        <fieldset class="form-group mb-3">
                            <input type="text" name="number" class="form-control bg-light-primary"
                                id="total_payment" value="" placeholder="Jumlah">
                        </fieldset>
                    </div>
                    <div class="col-md-6">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header btn-primary">
                <h5 class="modal-title text-light" id="exampleModalLabel">Refund / Penukaran [<span
        ...
        <div class="modal-content">
            <form id ="f_access">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary font-weight-bold">Lanjut Checkout</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <center>
                    ...
                    <h1 class="font-weight-bolder" style="font-size:22px;">Apakah Customer ingin isi rating ?<br />
                        Jika Ya silahkan input kode akses anda kemudian pilih Ya</h1>
...
<div class="modal fade" id="ProductBarcodeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body table-responsive">
                <input type="search" class="form-control form-control-sm col-6" id="p_search"
