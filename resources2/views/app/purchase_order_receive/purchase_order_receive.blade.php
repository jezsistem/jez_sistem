                ...
                <div class="col-lg-12 col-xxl-12">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header flex-wrap py-3">
                            ...
                            <div class="form-group" style="padding-top:22px;">
                                <div class="row">
                                <a href="#" class="btn btn-sm btn-light font-weight-bold mr-2 bg-primary" id="kt_dashboard_daterangepicker" data-toggle="tooltip" title="Tanggal PO untuk diexport" data-placement="left">
                        ...
                        <div class="card-body table-responsive">
                            <!--begin: Datatable-->
                            <input type="search" class="form-control form-control-sm col-6" id="purchase_order_search" placeholder="Cari PO / artikel warna"/><br/>
                            <table class="table table-hover table-checkable" id="PurchaseOrdertb">
                                <thead class="bg-primary text-light">
                                    <tr>
                                        ...
                                        <th class="text-light">Nomor Order</th>
...
<!--end::Content-->
@include('app.purchase_order_receive.purchase_order_receive_modal')
@include('app._partials.js')
@include('app.purchase_order_receive.purchase_order_receive_js')
@endSection()