    ...
    <div class="modal-dialog modal-xl" role="document" style="width:100%; max-width:1300px;">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-light" id="exampleModalLabel">Penerimaan PO #<span id="po_invoice_label"></span></h5>
            </div>
            <form id="f_po">
...
<div class="modal fade" id="PurchaseOrderReceiveDetailModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false" style="overflow-y: auto;">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-light" id="exampleModalLabel">History Terima <span id="purchase_article_label"></span></h5>
            </div>
                ...
                <table class="table table-hover" id="Poadstb">
                    <thead class="bg-primary text-light">
                        <tr>
                            ...
                            <th class="text-light">Pajak</th>
                            <th class="text-light" style="white-space:nowrap;">Qty Terima</th>
                            <th class="text-light">Disc</th>
                            <th class="text-light">ExDisc</th>
...
<div class="modal fade" id="EditPoadsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="overflow-y: auto;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-light" id="exampleModalLabel">Revisi Data</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary font-weight-bold" id="save_poads_btn">Simpan</button>
            </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="PoReportModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="overflow-y: auto;">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-light" id="exampleModalLabel">Laporan Penerimaan</h5>
            </div>
