...
<script>
    ...
    $(document).ready(function() {
        ...
        function highlight(label , status)
        {
            ...
            $('#cross_nett_sales_btn').addClass('btn-primary');
            $('#cross_profits_btn').addClass('btn-primary');
            $('#nett_sales_btn').addClass('btn-primary');
            $('#profits_btn').addClass('btn-primary');
            $('#cc_assets_btn').addClass('btn-primary');
            $('#c_assets_btn').addClass('btn-primary');
            $('#purchases_btn').addClass('btn-primary');
            $('#debts_btn').addClass('btn-primary');
            $('#cc_exc_assets_btn').addClass('btn-primary');
            $('#c_exc_assets_btn').addClass('btn-primary');
