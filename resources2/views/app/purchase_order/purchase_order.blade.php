                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header flex-wrap py-3">
                            ...
                            <div class="card-toolbar">
                                ...
                                <!--end::Dropdown-->
                                <!--begin::Button-->
                                <button href="#" class="btn btn-primary font-weight-bolder" id="add_po_btn">
                                <span class="svg-icon svg-icon-md">
                        ...
                        <div class="card-body table-responsive">
                            <!--begin: Datatable-->
                            <input type="search" class="form-control form-control-sm col-6" id="purchase_order_search" placeholder="Cari No PO / Artikel (brand nama warna)"/><br/>
...
<!--end::Content-->
@include('app.purchase_order.purchase_order_modal')
@include('app._partials.js')
@include('app.purchase_order.purchase_order_js')
@endSection()