                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header flex-wrap py-3">
                            <div class="card-toolbar">
                                ...
                                <!--end::Dropdown-->
                                <!--begin::Button-->
                                <a href="#" class="btn btn-primary font-weight-bolder" id="add_product_location_btn">
                                <span class="svg-icon svg-icon-md">
                        ...
                        <div class="card-body table-responsive">
                            <!--begin: Datatable-->
                            <input type="search" class="form-control form-control-sm col-6" id="product_location_search" placeholder="Cari lokasi simpan"/><br/>
                            <table class="table table-hover table-checkable" id="ProductLocationtb">
                                <thead class="bg-primary text-light">
                                    <tr>
                                        ...
                                        <th class="text-light">Default</th>
                                    </tr>
                                </thead>
                                <tbody>
...
<!--end::Content-->
@include('app.product_location.product_location_modal')
@include('app._partials.js')
@include('app.product_location.product_location_js')
@endSection()