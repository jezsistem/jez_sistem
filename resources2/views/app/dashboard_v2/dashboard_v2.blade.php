            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-xxl-12">
                    <div class="card card-custom card-stretch gutter-b" style="border-radius:15px; padding:10px;">
                        <div class="card-body p-0">
                            <div class="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
                                <span class="btn-sm btn-info font-weight-bolder font-size-h6">
                                    Store
                                </span>
                                <span class="btn-sm btn-primary font-weight-bolder font-size-h6" id="store_excel">
                                    Excel
                                </span>
                            </div>
                            ...
                            <table class="table table-hover table-checkable" id="Storetb">
                                <thead class="bg-primary text-light">
                                    <tr>
                                        ...
                                        <th class="text-light">Asset CC</th>
                                        <th class="text-light">Asset Con</th>
                    ...
                    <div class="card card-custom card-stretch gutter-b" style="border-radius:15px; padding:10px;">
                        <div class="card-body p-0">
                            <div class="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
                                ...
                                <span class="btn-sm btn-primary font-weight-bolder font-size-h6" id="brand_excel">
                                    Excel
                                </span>
                            </div>
                            <div class="table-responsive">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h5 class="modal-title text-light" id="exampleModalLabel">Silahkan klik tombol synchronize untuk mendapatkan update data terbaru, karena robot otomatis baru akan melakukan close setiap pukul 23.57</h5>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-light" id="exampleModalLabel">Mohon menunggu, permintaan anda sedang kami proses, sekitar 30 detik sampai 1 menit untuk kalkulasi summary per brand</h5>
            </div>
        </div>
    </div>
</div>
...
@include('app.dashboard_v2.dashboard_v2_js')
@endSection()
