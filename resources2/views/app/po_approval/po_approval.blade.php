                ...
                <div class="col-lg-12 col-xxl-12">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body table-responsive">
                            <!--begin: Datatable-->
                            <input type="search" class="form-control form-control-sm col-6" id="po_approval_search" placeholder="Cari po/invoice"/><br/>
                            <table class="table table-hover table-checkable" id="APtb">
                                <thead class="bg-primary text-light">
                                    <tr>
                                        <th class="text-light">No</th>
                                        <th class="text-light">Store</th>
                                        <th class="text-light">PO</th>
                                        <th class="text-light">Invoice</th>
                                        <th class="text-light">Tgl Invoice</th>
                                        <th class="text-light">Tgl Terima</th>
