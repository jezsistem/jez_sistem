                ...
                <div class="col-lg-12 col-xxl-12">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body table-responsive">
                            <input type="search" class="form-control bg-light-success col-4" id="po_receive_search" placeholder="Cari No PO"/><br/>
                            <table class="table table-hover table-checkable" id="PoReceivetb">
                                <thead class="bg-primary text-light">
                                    <tr>
                                        <th class="text-light">No</th>
                                        <th class="text-light" style="white-space:nowrap;">No PO</th>
                                        <th class="text-light" style="white-space:nowrap;">Store</th>
                                        <th class="text-light" style="white-space:nowrap;">Tgl PO</th>
                                        <th class="text-light" style="white-space:nowrap;">Tgl Terima</th>
...
<!--end::Content-->
@include('app.report.po_receive.po_receive_modal')
@include('app._partials.js')
@include('app.report.po_receive.po_receive_js')
@endSection()