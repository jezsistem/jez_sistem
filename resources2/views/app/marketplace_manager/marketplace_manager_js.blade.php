<script>
    ...
    $(document).ready(function() {
        ...
        var stock_table = $('#Stocktb').DataTable({
            ...
            ajax: {
                url : "{{ url('marketplace_stock_datatables') }}",
                data : function (d) {
        ...
        function exportTable(std_id)
        {
            ...
            $.ajax({
                type:'POST',
                url: "{{ url('export_marketplace_table') }}",
                data: data,
                cache:false,
                contentType: false,
                processData: false,
        ...
        function checkCode(mm_id, pst_id, code)
        {
            ...
            $.ajax({
                type:'POST',
                url: "{{ url('check_marketplace_code') }}",
                data: {code:code},
                dataType: 'json',
                success: function(r) {
                    if (r.status == '200') {
        ...
        function updateCode(mm_id, pst_id, code)
        {
            ...
            $.ajax({
                type:'POST',
                url: "{{ url('update_marketplace_code') }}",
        ...
        $('#f_import').on('submit', function(e) {
            ...
            $.ajax({
                type:'POST',
                url: "{{ url('marketplace_stock_refresh')}}",
                data: formData,
                cache:false,
                contentType: false,
                processData: false,
        ...
        $('#f_import_template').on('submit', function(e) {
            ...
            $.ajax({
                type:'POST',
                url: "{{ url('marketplace_template_import')}}",
                data: formData,
				dataType: 'json',
                cache:false,
                contentType: false,
