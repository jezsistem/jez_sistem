        ...
        <div class="card-spacer" style="padding-top: 0px;">
            ...
            <div class="row m-0">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-header h-auto align-items-center justify-content-between">
                            <div class="col-6 mt-8">
                                ...
                                <button type="button" class="btn btn-success font-weight-bolder mt-2" aria-haspopup="true" aria-expanded="false" id="import_btn">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-body table-responsive">
                            <button type="button" class="btn btn-success font-weight-bolder mt-2" id="fetch_btn">
                            <span class="svg-icon svg-icon-md">
                                <!--begin::Svg Icon | path:assets/media/svg/icons/Design/PenAndRuller.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
<!--end::Content-->
@include('app.marketplace_manager.marketplace_manager_modal')
@include('app._partials.js')
@include('app.marketplace_manager.marketplace_manager_js')
@endSection()
