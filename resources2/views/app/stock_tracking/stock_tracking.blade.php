            ...
            <div class="col-lg-12 col-xxl-12">
                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-body table-responsive">
                        <!--begin: Datatable-->
                        <input type="search" class="form-control form-control-sm col-6" id="stock_tracking_search" placeholder="Cari artikel / customer / invoice (ketik minimal 5 karakter)"/><br/>
                        <table class="table table-hover table-checkable" id="StockTrackingtb">
                            <thead class="bg-primary text-light">
                                <tr>
                                    <th class="text-light">No</th>
                                    <th class="text-light">Tanggal <i><small>* pergerakan stock</small></i></th>
                                    <th class="text-light">Artikel <i><small>* silahkan klik item dibawah untuk melihat detail user terlibat</small></i></th>
                                    <th class="text-light">Invoice</th>
                                    <th class="text-light">Cust</th>
