...
<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside" style="background:#000;">
    ...
    <!--end::Brand-->
    <!--begin::Aside Menu-->
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper" style="background:#000;">
        <!--begin::Menu Container-->
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500" style="background:#000;">
            <!--begin::Menu Nav-->
            <ul class="menu-nav">
                @if (!empty($data['sidebar']))
                @foreach ($data['sidebar'] as $row)
                <li class="menu-section">
                    <h4 class="menu-text">{{ $row->mt_title }}</h4>
