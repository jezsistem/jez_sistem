        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a href="#" class="btn btn-sm btn-light font-weight-bold mr-2 bg-success" data-toggle="modal"
                        data-target="#ChangePasswordModal">
                        <span class="font-size-base">Ganti Password</span>
                    </a>
                    <a href="{{ url('logout') }}" class="btn btn-sm btn-light font-weight-bold mr-2 bg-danger"
                    ...
                    <div class="col-lg-12 col-xxl-12" id="user_activity_reload">
                        ...
                        <div class="card card-custom card-stretch gutter-b">
                            ...
                            <div class="card-header align-items-center border-0 mt-4">
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="font-weight-bolder font-size-h3 btn bg-dark text-white"
                                        id="scan_in_btn">Scan Masuk Rak</span>
                                    <!-- <span class="text-muted mt-3 font-weight-bold font-size-sm">112 Aktifitas terbaru</span> -->
                                </h3>

                                <h3 class="card-title align-items-start flex-column">
                                    <span class="font-weight-bolder font-size-h3 btn bg-dark text-white"
                                        id="scan_in_refund_btn">Scan Masuk Refund</span>
                                    <!-- <span class="text-muted mt-3 font-weight-bold font-size-sm">112 Aktifitas terbaru</span> -->
                                </h3>
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="font-weight-bolder font-size-h3 btn bg-dark text-white"
                                        id="scan_keep_btn">Keep Online</span>
                                    <!-- <span class="text-muted mt-3 font-weight-bold font-size-sm">112 Aktifitas terbaru</span> -->
                                </h3>
                                {{--                            <h3 class="card-title align-items-start flex-column"> --}}
                            ...
                            <div class="card-header align-items-center border-0 mt-4">
                                <h3 class="card-title align-items-start flex-column">
                                    <a href="{{ url('cross_order') }}">
                                        <span class="font-weight-bolder font-size-h3 btn bg-dark text-white">Cross
                                            Order</span>
                                        <!-- <span class="text-muted mt-3 font-weight-bold font-size-sm">112 Aktifitas terbaru</span> -->
                                    </a>
                                </h3>
                                <h3 class="card-title align-items-start flex-column">
                                    <a href="{{ url('setup_lokasi_stok_v2') }}"><span
                                            class="font-weight-bolder font-size-h3 btn bg-dark text-white"
                                            id="mutation_btn">Mutasi</span></a>
                                    <!-- <span class="text-muted mt-3 font-weight-bold font-size-sm">112 Aktifitas terbaru</span> -->
                                </h3>
                                <h3 class="card-title align-items-start flex-column">
                                    <a href="{{ url('setup_lokasi_stok_v2') }}"><span
                    ...
                    <div class="col-lg-12 col-xxl-12" id="user_activity_reload">
                        ...
                        <div class="card card-custom card-stretch gutter-b">
                            ...
                            <div class="card-header align-items-center border-0 mt-4">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="font-weight-bolder font-size-h3 btn bg-dark text-white"
                                        id="scan_transfer_btn">Scan Ambil Item Transfer</span>
                                    <!-- <span class="text-muted mt-3 font-weight-bold font-size-sm">112 Aktifitas terbaru</span> -->
                                </h3>
                            </div>
                            <!--end::Header-->
