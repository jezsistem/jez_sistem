            ...
            <tbody>
                ...
                <tr>
                    ...
                    <br/>   <a class="btn btn-sm btn-primary">Jml : {{ $qty_pickup }}</a>
                            ...
                            <a class="btn btn-sm btn-inventory" data-pos_td_qty="{{ $row->pos_td_qty }}" data-id="{{ $row->ptd_id }}" data-name="{{ $row->p_name }}" data-pl_id="{{ $row->pl_id }}" data-pst="{{ $row->pst_id }}" id="pl_id">
                                Ambil
                            </a>
