                ...
                <div class="col-lg-12 col-xxl-12">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body table-responsive">
                            <!--begin: Datatable-->
                            <input type="search" class="form-control form-control-sm col-6" id="invoice_tracking_search" placeholder="Cari invoice / nomor resi / customer"/><br/>
                            <table class="table table-hover table-checkable" id="CrossOrdertb">
                                <thead class="bg-primary text-light">
                                    <tr>
                                        ...
                                        <th class="text-light">Kasir Tujuan</th>
