                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header flex-wrap py-3">
                            <div class="card-toolbar">
                                ...
                                <!--end::Dropdown-->
                                <!--begin::Button-->
                                <a href="#" class="btn btn-primary font-weight-bolder" id="add_investor_btn">
                                <span class="svg-icon svg-icon-md">
                        ...
                        <div class="card-body table-responsive">
                            <!--begin: Datatable-->
                            <input type="search" class="form-control form-control-sm col-6" id="investor_search" placeholder="Cari investor"/><br/>
...
<!--end::Content-->
@include('app.investor.investor_modal')
@include('app._partials.js')
@include('app.investor.investor_js')
@endSection()
