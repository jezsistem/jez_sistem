        ...
        <div class="row align-items-center">
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="greeting-text">
                    <a href="<?php echo e(url('/redirect')); ?>"><h3 class="card-label mb-0 font-weight-bold text-white"><?php echo e($data['app_title']); ?></h3></a>
...
</header><?php /**PATH /home/sistem.jez.co.id/public_html/resources/views/app/pos/pos_header.blade.php ENDPATH**/ ?>