<script>
    $(document).ready(function() {
        ...
        var product_unit_table = $('#ProductUnittb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('product_unit_datatables')); ?>",
                data : function (d) {
        ...
        $('#pu_name').on('change', function() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                url: "<?php echo e(url('check_exists_product_unit')); ?>",
                success: function(r) {
                    if (r.status == '200') {
...
</script><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/product_unit/product_unit_js.blade.php ENDPATH**/ ?>