<script>
    $(document).ready(function() {
        ...
        var account_table = $('#Accounttb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('account_datatables')); ?>",
                data : function (d) {
        ...
        $('#a_name').on('change', function() {
            ...
            $.ajax({
                ...
                data: {_a_name:a_name},
                dataType: 'json',
                url: "<?php echo e(url('check_exists_account')); ?>",
                success: function(r) {
                    if (r.status == '200') {
        ...
        $('#a_code').on('change', function() {
            ...
            $.ajax({
                ...
                data: {_a_code:a_code},
                dataType: 'json',
                url: "<?php echo e(url('check_exists_account_code')); ?>",
                success: function(r) {
                    if (r.status == '200') {
...
</script><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/account/account_js.blade.php ENDPATH**/ ?>