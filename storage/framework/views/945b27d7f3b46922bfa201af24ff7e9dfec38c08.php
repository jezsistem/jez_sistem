...
<script>
    ...
    $(document).ready(function() {
        ...
        var article_table = $('#article_table').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('stc_article_datatables')); ?>",
                data : function (d) {
        ...
        function getExport() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(url('stock_report_export')); ?>",
                xhrFields: {
                    responseType: 'blob' 
                },
        ...
        function phase2() {
            ...
            $.ajax({
                ...
                dataType: "json",
                url: "<?php echo e(url('stock_report_phase2')); ?>",
                success: function(r) {
                    if (r.status == '200') {
                        phase3();
                    }
        ...
        function phase3() {
            ...
            $.ajax({
                ...
                data: {st_id:st_id, br_id:br_id, date:dashboard_date, exception:exception},
                dataType: "json",
                url: "<?php echo e(url('stock_report_phase3')); ?>",
                success: function(r) {
                    if (r.status == '200') {
                        getExport();
                    }
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        data: {st_id:st_id, br_id:br_id, date:dashboard_date, exception:exception},
                        dataType: "json",
                        url: "<?php echo e(url('stock_report_fill_data')); ?>",
                        success: function(r) {
                            if (r.status == '200') {
                                phase2();
                            }
...
<?php /**PATH /home/sistem.jez.co.id/public_html/resources/views/app/stock_card/stock_card_js.blade.php ENDPATH**/ ?>