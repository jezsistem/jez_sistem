<script>
    $(document).ready(function () {
        ...
        var online_transaction_table = $('#OnlineTransactionb').DataTable({
            ...
            ajax: {
                url: "<?php echo e(url('transaksi_online_datatables')); ?>",
                data: function (d) {
        ...
        var detail_table = $('#Detailtb').DataTable({
            ...
            ajax: {
                url: "<?php echo e(url('transaksi_online_datatables_detail')); ?>",
                data: function (d) {
                    d.to_id = $('#to_id').val();
                }
            },
        ...
        $(document).delegate('#print_invoice', 'click', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '<?php echo e(url('print_online_invoice')); ?>',
                        method: 'POST',
                        data: {
                        ...
                        success: function (response) {
                            var printUrl = '<?php echo e(url('print_online_nota')); ?>/' + numOrder;
...
</script><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/online_transaction/online_transaction_js.blade.php ENDPATH**/ ?>