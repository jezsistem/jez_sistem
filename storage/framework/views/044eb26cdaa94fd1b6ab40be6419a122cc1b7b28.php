<script>
    ...
    $(document).ready(function() {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        url: "<?php echo e(url('delete_logo_brand')); ?>",
                        success: function(r) {
                            if (r.status == '200'){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        url: "<?php echo e(url('delete_banner_brand')); ?>",
                        success: function(r) {
                            if (r.status == '200'){
        ...
        var brand_table = $('#Brandtb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('brand_datatables')); ?>",
                data : function (d) {
        ...
        $('#Brandtb tbody').on('click', 'tr td:not(:nth-child(2), :nth-child(3))', function () {
            ...
            if (br_image != null) {
                $('#imagePreview').attr('src', "<?php echo e(asset('api/brand/')); ?>/"+br_image);
            }
            if (br_banner != null) {
                $('#bannerPreview').attr('src', "<?php echo e(asset('api/brand/banner/')); ?>/"+br_banner);
            }
            $('#_id').val(id);
            $('#_mode').val('edit');
            $('#_image').val(br_image);
        ...
        $('#br_name').on('change', function() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                url: "<?php echo e(url('check_exists_brand')); ?>",
                success: function(r) {
                    if (r.status == '200') {
...
</script><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/brand/brand_js.blade.php ENDPATH**/ ?>