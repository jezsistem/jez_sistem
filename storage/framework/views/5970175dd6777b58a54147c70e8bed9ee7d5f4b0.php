<script>
    $(document).ready(function() {
        ...
        var product_supplier_table = $('#ProductSuppliertb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('product_supplier_datatables')); ?>",
                data : function (d) {
        ...
        $('#ps_name').on('change', function() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                url: "<?php echo e(url('check_exists_supplier')); ?>",
                success: function(r) {
                    if (r.status == '200') {
...
</script><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/product_supplier/product_supplier_js.blade.php ENDPATH**/ ?>