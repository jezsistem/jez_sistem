...
<script>
    ...
    $(document).ready(function() {
        ...
        var user_shift_table = $('#UserShiftTb').DataTable({
            ...
            ajax: {
                url: "<?php echo e(url('report_shift_datatables')); ?>",
                type: 'GET',
                data: function (d) {
        ...
        $('#UserShiftTb tbody').on('click', 'tr', function () {
            ...
            $.ajax({
                url: "<?php echo e(url('report_shift_detail')); ?>",
                type: 'post',
                data: {
                    id: data,
...
</script><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/report/shift/shift_js.blade.php ENDPATH**/ ?>