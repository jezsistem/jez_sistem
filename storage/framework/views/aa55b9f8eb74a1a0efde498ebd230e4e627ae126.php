...
<?php $__env->startSection('content'); ?>
                                            ...
                                            <ul class="navi flex-column navi-hover py-2">
                                                ...
                                                <li class="navi-item">
                                                    ...
                                                    <span class="navi-icon">
                                                        ...
                                                        <span id="user_shift_excel_btn"></span>
                                                    </a>
                                                </li>
                                            </ul>
                                            <!--end::Navigation-->
    ...
    <?php echo $__env->make('app.report.shift.shift_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('app.report.shift.shift_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('app.structure', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/report/shift/shift.blade.php ENDPATH**/ ?>