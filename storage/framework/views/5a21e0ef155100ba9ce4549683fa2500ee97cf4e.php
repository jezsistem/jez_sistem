<script>
    $(document).ready(function() {
        ...
        var stock_transfer_data_table = $('#StockTransferDatatb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('transfer_data_datatables')); ?>",
                data : function (d) {
        ...
        var stock_transfer_data_accept_table = $('#StockTransferDataAccepttb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('transfer_data_accept_datatables')); ?>",
                data : function (d) {
        ...
        var history_table = $('#Historytb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('transfer_data_history_datatables')); ?>",
                data : function (d) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({    
                        ...
                        dataType: 'json',
                        url: "<?php echo e(url('stock_transfer_accept')); ?>",
                        success: function(r) {
                            if (r.status == '200'){
                                stock_transfer_data_table.draw();
                                stock_transfer_data_accept_table.draw();
        ...
        $(document).delegate('#std_export_all_btn', 'click', function(e) {
            ...
            window.location.href = "<?php echo e(url('std_export')); ?>?start="+start_date+"&end="+end_date+"";
        });
...
</script><?php /**PATH /home/sistem.jez.co.id/public_html/resources/views/app/stock_transfer_data/stock_transfer_data_js.blade.php ENDPATH**/ ?>