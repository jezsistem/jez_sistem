...
<table class="table table-hover table-checkable" id="PurchaseOrdertb">
    ...
    <tbody>
        ...
        <tr>
            ...
            [<?php echo e($row->br_name); ?>] <?php echo e($row->p_name); ?><br/><?php echo e($row->p_color); ?> <img onclick="return deletePoa( <?php echo e($row->poa_id); ?>, <?php echo e($row->po_id); ?> )" src="<?php echo e(asset('cdn/details_close.png')); ?>"/><br/>
...
<?php endif; ?>
<?php /**PATH /home/sistem.jez.co.id/public_html/resources/views/app/pre_order/_purchase_order_article_detail.blade.php ENDPATH**/ ?>