    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header bg-light">
                <h5 class="modal-title text-dark" id="exampleModalLabel">Data Store</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-dark font-weight-bold" id="save_store_btn">Simpan</button>
            </div>
            </form>
        </div>
    </div>
</div>
<!-- /Modal --><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/store/store_modal.blade.php ENDPATH**/ ?>