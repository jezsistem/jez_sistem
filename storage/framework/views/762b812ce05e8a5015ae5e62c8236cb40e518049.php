<script>
    ...
    $(document).ready(function() {
        ...
        var invoice_tracking_table = $('#InvoiceTrackingtb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('invoice_tracking_datatables')); ?>",
                data : function (d) {
        ...
        $(document).delegate('#shipping_number_btn', 'click', function() {
            ...
            if (image != '') {
                $('#imagePreview').attr('src', "<?php echo e(asset('upload/shipping_img/600x600')); ?>/"+image);
            }
        });
        ...
        $('#f_payment_dp').on('submit', function(e){
            ...
            $.ajax({
                type:'POST',
                url: "<?php echo e(url('invoice_dp_repayment')); ?>",
                data: formData,
                dataType: 'json',
                cache:false,
                contentType: false,
        ...
        $('#search_complaint_btn').on('click', function() {
            ...
            $.ajax({
                type:'POST',
                url: "<?php echo e(url('search_invoice')); ?>",
...
<?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/invoice_tracking/invoice_tracking_js.blade.php ENDPATH**/ ?>