        ...
        <div class="topbar">
            <div class="header-mobile header-mobile-fixed col-2">
                <div class="topbar-item btn-sm" id="kt_aside_mobile_toggle">
                    <img alt="Logo" src="<?php echo e(asset('logo')); ?>/jez_pro.png" width="100px"/>
                </div>
            </div>
...
</div><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/_partials/header.blade.php ENDPATH**/ ?>