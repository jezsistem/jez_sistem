...
<script>
    $(document).ready(function() {
        ...
        var bcc_table = $('#Bcctb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('bcc_datatables')); ?>",
                data : function (d) {
        ...
        $('#Bcctb tbody').on('click', 'tr td:not(:nth-child(5))', function () {
            ...
            $('#bc_id').val(bc_id);
            if (bcc_image != '') {
                $('#bcc_image_preview').html('<img src="<?php echo e(url('/')); ?>/api/blog/300/'+bcc_image+'" style="width:300px;" class="bcc_image_item"/>');
        ...
        $('#bcc_title').on('change', function() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                url: "<?php echo e(url('check_exists_mtd')); ?>",
                success: function(r) {
                    if (r.status == '200') {
...
</script><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/blog/blog_js.blade.php ENDPATH**/ ?>