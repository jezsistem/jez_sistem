<script>
    $(document).ready(function() {
        ...
        var rating_table = $('#Ratingtb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('rating_datatables')); ?>",
                data : function (d) {
        ...
        var rating_history_table = $('#RatingHistorytb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('rating_history_datatables')); ?>",
                data : function (d) {
...
</script><?php /**PATH C:\laragon\www\jez_sistem\resources\views/app/user_rating/user_rating_js.blade.php ENDPATH**/ ?>