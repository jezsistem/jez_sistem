<script>
    $(document).ready(function() {
        ...
        var season_table = $('#Seasontb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('season_datatables')); ?>",
                data : function (d) {
        ...
        $('#ss_name').on('change', function() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                url: "<?php echo e(url('check_exists_season')); ?>",
                success: function(r) {
                    if (r.status == '200') {
...
</script><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/season/season_js.blade.php ENDPATH**/ ?>