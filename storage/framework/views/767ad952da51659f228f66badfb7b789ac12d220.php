            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-xxl-12">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body table-responsive">
                            <!--begin: Datatable-->
                            <input type="search" class="form-control  col-6" id="data_search" placeholder="Cari store / penanggung jawab"/><br/>
                            ...
                            <table class="table table-hover table-checkable" id="Invoicetb">
                                <thead class="bg-light text-dark">
                                    <tr>
                                        ...
                                        <th class="text-dark">Total<br/><span style='white-space:nowrap;'>(-admin)</span></th>
                ...
                <div class="col-lg-12 col-xxl-12">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-body table-responsive">
                            <h6>History Edit</h6>
                            <input type="search" class="form-control  col-6" id="history_search" placeholder="Cari invoice / user"/><br/>
...
<!--end::Content-->
<?php echo $__env->make('app.invoice_editor.invoice_editor_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('app._partials.js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('app.invoice_editor.invoice_editor_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('app.structure', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/invoice_editor/invoice_editor.blade.php ENDPATH**/ ?>