<!-- Modal-->
<div class="modal fade" id="StockTransferDataModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header bg-light">
                ...
                <div class="dropdown dropdown-inline mr-2">
                    <a type="button" class="btn btn-dark font-weight-bolder" id="ExportBtn"
...
<!-- /Modal --><?php /**PATH /home/dev.jez.co.id/public_html/resources/views/app/stock_transfer_data/stock_transfer_data_modal.blade.php ENDPATH**/ ?>