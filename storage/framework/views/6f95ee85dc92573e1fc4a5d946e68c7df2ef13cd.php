                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header flex-wrap py-3">
                            <div class="card-toolbar">
                                        ...
                                        <ul class="navi flex-column navi-hover py-2">
                                            ...
                                            <li class="navi-item">
                                                <a href="#" class="navi-link">
                                                    ...
                                                    <span id="investor_excel_btn"></span>
                                                </a>
                                            </li>
                                        </ul>
                                        <!--end::Navigation-->
                                ...
                                <!--end::Dropdown-->
                                <!--begin::Button-->
                                <a href="#" class="btn btn-dark font-weight-bolder" id="add_investor_btn">
                                <span class="svg-icon svg-icon-md">
                        ...
                        <div class="card-body table-responsive">
                            <!--begin: Datatable-->
                            <input type="search" class="form-control  col-6" id="investor_search" placeholder="Cari investor"/><br/>
...
<!--end::Content-->
<?php echo $__env->make('app.investor.investor_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('app._partials.js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('app.investor.investor_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('app.structure', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sistem.jez.co.id/public_html/resources/views/app/investor/investor.blade.php ENDPATH**/ ?>