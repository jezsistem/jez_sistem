<script>
    $(document).ready(function() {
        ...
        var product_sub_category_table = $('#ProductSubCategorytb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('product_sub_category_datatables')); ?>",
                data : function (d) {
        ...
        $('#psc_name').on('change', function() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                url: "<?php echo e(url('check_exists_product_sub_category')); ?>",
                success: function(r) {
                    if (r.status == '200') {
...
</script><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/product_sub_category/product_sub_category_js.blade.php ENDPATH**/ ?>