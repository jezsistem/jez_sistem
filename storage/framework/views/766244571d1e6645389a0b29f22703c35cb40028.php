<script>
    ...
    function loadBrand(query)
    {
        if($.trim(query) != '' || $.trim(query) != null) {
            ...
            $.ajax({
                url:"<?php echo e(url('fetch_start_scan_adjustment_brand')); ?>",
                method:"POST",
                data:{query:query},
    ...
    function loadSubCategory(query)
    {
        if($.trim(query) != '' || $.trim(query) != null) {
            ...
            $.ajax({
                url:"<?php echo e(url('fetch_start_scan_adjustment_sub_category')); ?>",
                method:"POST",
                data:{query:query},
                success:function(data){
    ...
    $(document).ready(function() {
        ...
        var scan_adjustment_table = $('#SAtb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('scan_adjustment_datatables')); ?>",
                data : function (d) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        data: {id:id},
                        dataType: 'json',
                        url: "<?php echo e(url('scan_adjustment_approval')); ?>",
                        success: function(r) {
                            if (r.status == '200'){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        data: {id:id},
                        dataType: 'json',
                        url: "<?php echo e(url('scan_adjustment_finish')); ?>",
                        success: function(r) {
                            if (r.status == '200'){
        ...
        $(document).delegate('#report_btn', 'click', function(e){
            ...
            swal({
                ...
                if (isConfirm) {
                    window.location.href = "<?php echo e(url('scan_adjustment_export')); ?>?id="+id+"";
                }
            })
        });
        ...
        var brand_table = $('#Brtb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('scan_adjustment_custom_datatables')); ?>",
                data : function (d) {
                    d.type = 'brand';
                    d.id = sa_id;
                }
        ...
        $(document).delegate('#bin_btn', 'click', function(e){
            ...
            swal({
                ...
                if (isConfirm) {
                    window.location.href = "<?php echo e(url('export_start_scan_adjustment_bin')); ?>?id="+id+"";
                }
            })
        });
        ...
        function loadCustomItem(query, type)
        {
            if($.trim(query) != '' || $.trim(query) != null) {
                ...
                $.ajax({
                    url:"<?php echo e(url('fetch_start_scan_adjustment_custom')); ?>",
                    method:"POST",
        ...
        function addCustom(id, type)
        {
            ...
            $.ajax({
                ...
                dataType: 'json',
                url: "<?php echo e(url('add_start_scan_adjustment_custom')); ?>",
                success: function(r) {
                    if (r.status == '200'){
                        if (type == 'brand') {
                            brand_table.draw();
        ...
        function deleteCustom(id, type)
        {
            ...
            $.ajax({
                ...
                dataType: 'json',
                url: "<?php echo e(url('delete_start_scan_adjustment_custom')); ?>",
                success: function(r) {
                    if (r.status == '200'){
                        if (type == 'brand') {
                            brand_table.draw();
...
<?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/scan_adjustment/scan_adjustment_js.blade.php ENDPATH**/ ?>