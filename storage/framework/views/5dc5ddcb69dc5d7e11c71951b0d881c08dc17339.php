<script>
    $(document).ready(function() {
        ...
        var exception_location_table = $('#ExceptionLocationtb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('exception_location_datatables')); ?>",
                data : function (d) {
        ...
        //         dataType: 'json',
        //         url: "<?php echo e(url('check_exists_exception_location')); ?>",
        //         success: function(r) {
        //             if (r.status == '200') {
...
</script><?php /**PATH /home/sistem.jez.co.id/public_html/resources/views/app/exception_location/exception_location_js.blade.php ENDPATH**/ ?>