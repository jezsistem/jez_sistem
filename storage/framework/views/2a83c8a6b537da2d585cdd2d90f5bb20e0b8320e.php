...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                        ...
                        <div class="card card-custom gutter-b">
                            <div class="card-body">
                                ...
                                <div class="form-group mb-1 pb-1">
                                    ...
                                    <div id="platform_type_parent"></div>
                                </div>
                                <!--end: Datatable-->
                            </div>
                        </div>
        ...
        <div class="d-flex flex-column-fluid">
            <!--begin::Container-->
            <div class="container" id="shopee_div" style="display:none;">
                <div class="row">
                    <div class="col-lg-12 col-xxl-12">
                        <!--begin::Card-->
                        <div class="card card-custom gutter-b">
                            <div class="card-header flex-wrap py-3">
                                <div class="card-toolbar">
                                            ...
                                            <ul class="navi flex-column navi-hover py-2">
                                                ...
                                                <li class="navi-item">
                                                    ...
                                                    <span class="navi-icon">
                                                        ...
                                                        <span id="product_location_excel_btn"></span>
                                                    </a>
                                                </li>
                                            </ul>
                                            <!--end::Navigation-->
                                    ...
                                    <!--end::Dropdown-->
                                    <!--begin::Button-->
                                    <a href="#" class="btn btn-dark font-weight-bolder" id="add_product_location_btn">
                                <span class="svg-icon svg-icon-md">
                            ...
                            <div class="card-body table-responsive">
                                <!--begin: Datatable-->
                                <input type="search" class="form-control  col-6" id="product_location_search" placeholder="Cari lokasi simpan"/><br/>
    ...
    <!--end::Content-->
    <?php echo $__env->make('app.product_location.product_location_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('app._partials.js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('app.product_location.product_location_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('app.structure', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\jez_sistem\resources\views/app/online_transaction/online_transaction2.blade.php ENDPATH**/ ?>