    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2 bg-primary" style="border-radius:10px;">
                <!--begin::Page Title-->
                <h5 class="text-white font-weight-bold mt-2 mb-2 mr-5 ml-5"><?php echo e($data['user']->u_name); ?></h5>
                <!--end::Page Title-->
            </div>
            <!--end::Info-->
            <!--begin::Toolbar-->
            <div class="d-flex align-items-center">
                ...
                <a href="<?php echo e(url('logout')); ?>" class="btn btn-sm btn-light font-weight-bold mr-2 bg-danger" data-toggle="tooltip" data-placement="left">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-xxl-12" id="user_activity_reload">
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <div class="card-header align-items-center border-0 mt-4">
                            <h3 class="card-title align-items-start flex-column">
                                <a href="<?php echo e(url('cross_order')); ?>">
                                    <span class="font-weight-bolder font-size-h3 btn bg-dark text-white">Cross Order</span>
                                    <!-- <span class="text-muted mt-3 font-weight-bold font-size-sm">112 Aktifitas terbaru</span> -->
                                </a>
                            </h3>
                            <h3 class="card-title align-items-start flex-column">
                                <a href="<?php echo e(url('setup_lokasi_stok_v2')); ?>"><span class="font-weight-bolder font-size-h3 btn bg-dark text-white"  id="mutation_btn">Mutasi</span></a>
                                <!-- <span class="text-muted mt-3 font-weight-bold font-size-sm">112 Aktifitas terbaru</span> -->
                            </h3>
                            <h3 class="card-title align-items-start flex-column">
                                <a href="<?php echo e(url('setup_lokasi_stok_v2')); ?>"><span class="font-weight-bolder font-size-h3 btn bg-dark text-white"  id="article_btn">Data Artikel</span></a>
                                <!-- <span class="text-muted mt-3 font-weight-bold font-size-sm">112 Aktifitas terbaru</span> -->
                            </h3>
                            <h3 class="card-title align-items-start flex-column">
...
<!--end::Content-->
<?php echo $__env->make('app.dashboard.helper.dashboard_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('app._partials.js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('app.dashboard.helper.dashboard_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('app.structure', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/dashboard/helper/dashboard.blade.php ENDPATH**/ ?>