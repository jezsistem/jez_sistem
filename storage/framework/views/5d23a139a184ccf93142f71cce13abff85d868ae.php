<script>
    $(document).ready(function() {
        ...
        var account_classification_table = $('#AccountClassificationtb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('account_classification_datatables')); ?>",
                data : function (d) {
        ...
        $('#ac_name').on('change', function() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                url: "<?php echo e(url('check_exists_account_classification')); ?>",
                success: function(r) {
                    if (r.status == '200') {
...
</script><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/account_classification/account_classification_js.blade.php ENDPATH**/ ?>