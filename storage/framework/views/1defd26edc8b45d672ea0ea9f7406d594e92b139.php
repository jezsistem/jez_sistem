                ...
                <div class="col-lg-12 col-xxl-12">
                    ...
                    <div class="card card-custom gutter-b">
                                        ...
                                        <ul class="navi flex-column navi-hover py-2">
                                            ...
                                            <li class="navi-item">
                                                <a href="#" class="navi-link">
                                                    ...
                                                    <span id="product_sub_sub_category_excel_btn"></span>
                                                </a>
                                            </li>
                                        </ul>
                                        <!--end::Navigation-->
                        ...
                        <div class="card-body table-responsive">
                            <!--begin: Datatable-->
                            <input type="search" class="form-control  col-6" id="product_sub_sub_category_search" placeholder="Cari sub kategori artikel"/><br/>
                            <table class="table table-hover table-checkable" id="ProductSubSubCategorytb">
...
<!--end::Content-->
<?php echo $__env->make('app.product_sub_sub_category_test.product_sub_sub_category_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('app._partials.js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('app.product_sub_sub_category_test.product_sub_sub_category_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('app.structure', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/product_sub_sub_category_test/product_sub_sub_category.blade.php ENDPATH**/ ?>