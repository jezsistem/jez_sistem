<script>
    $('#purchase_label_reload').text(addCommas(<?php echo e($data['total']); ?>));
...
<?php /**PATH /home/sistem.jez.co.id/public_html/resources/views/app/dashboard/_load_purchase.blade.php ENDPATH**/ ?>