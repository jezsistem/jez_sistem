        ...
        <div class="card-spacer" style="padding-top: 0px;">
            ...
            <div class="row m-0">
                ...
                <div class="col bg-primary px-3 py-8 rounded-xl mr-7 mb-7">
                    ...
                    <a href="#" class="text-light font-weight-bold font-size-h6 mt-2"><?php echo e($data['total_product']); ?> Total</a>
                </div>
                ...
                <div class="col bg-primary px-3 py-8 rounded-xl mr-7 mb-7">
                    ...
                    <a href="#" class="text-light font-weight-bold font-size-h6 mt-2"><?php echo e($data['total_apparel']); ?> Apparel</a>
                </div>
                ...
                <div class="col bg-primary px-3 py-8 rounded-xl mr-7 mb-7">
                    ...
                    <a href="#" class="text-light font-weight-bold font-size-h6 mt-2"><?php echo e($data['total_footwear']); ?> Footwear</a>
                </div>
                ...
                <div class="col bg-primary px-3 py-8 rounded-xl mr-7 mb-7">
                    ...
                    <a href="#" class="text-light font-weight-bold font-size-h6 mt-2"><?php echo e($data['total_accessories']); ?> Accessories</a>
                </div>
                ...
                <div class="col bg-primary px-3 py-8 rounded-xl mb-7">
                    ...
                    <a href="#" class="text-light font-weight-bold font-size-h6 mt-2"><?php echo e($data['total_others']); ?> Others</a>
                </div>
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header flex-wrap py-3">
                            ...
                            <div class="dropdown dropdown-inline mr-2">
                                <button type="button" class="btn btn-light-primary font-weight-bolder" id="import_modal_btn" aria-haspopup="true" aria-expanded="false">
                                ...
                                <a href="#" class="btn btn-info font-weight-bolder ml-2" id="product_barcode_btn">
                                <span class="svg-icon svg-icon-md">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header flex-wrap py-1">
                            ...
                            <div class="form-group" style="padding-top:22px;">
                                <select class="form-control" id="br_id_filter" name="br_id_filter" required>
                                ...
                                <div id="br_id_filter_parent"></div>
                            </div>
                            <!--end: Datatable-->
                            <!--begin: Datatable-->
                            <div class="form-group" style="padding-top:22px;">
                                <select class="form-control" id="ps_id_filter" name="ps_id_filter" required>
                                ...
                                <div id="ps_id_filter_parent"></div>
                            </div>
                            <!--end: Datatable-->
                            <!--begin: Datatable-->
                            <div class="form-group" style="padding-top:22px;">
                                <select class="form-control" id="mc_id_filter" name="mc_id_filter" required>
                                ...
                                <div id="mc_id_filter_parent"></div>
                            </div>
                            <!--end: Datatable-->
                            <!--begin: Datatable-->
                            <div class="form-group" style="padding-top:22px;">
                            ...
                            <div class="card-toolbar">
                                        ...
                                        <ul class="navi flex-column navi-hover py-2">
                                            ...
                                            <li class="navi-item">
                                                <a href="#" class="navi-link">
                                                    ...
                                                    <span id="product_excel_btn"></span>
                                                </a>
                                                <a href="<?php echo e(url('p_export')); ?>" class="navi-link">
                                                    <span class="navi-icon">
                                                        <i class="la la-copy"></i>
                                                    </span>
                                                    <span class="btn btn-primary btn-xs">Export All</span>
                                                </a>
                                                <a href="<?php echo e(url('p_export_barcode')); ?>" class="navi-link">
                                                    <span class="navi-icon">
                                                        <i class="la la-copy"></i>
                                                    </span>
                                ...
                                <!--end::Dropdown-->
                                <!--begin::Button-->
                                <a href="#" class="btn btn-dark font-weight-bolder" id="add_product_btn">
                                <span class="svg-icon svg-icon-md">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Flatten.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <div class="table-responsive">
                            <!--begin: Datatable-->
                            <center><input type="search" class="form-control  col-6" id="product_search" placeholder="Cari nama artikel / warna / brand / supplier"/></center><br/>
...
<!--end::Content-->
<?php echo $__env->make('app.product.product_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('app._partials.js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('app.product.product_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('app.structure', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/product/product.blade.php ENDPATH**/ ?>