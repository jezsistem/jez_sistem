                ...
                <div class="col-lg-12 col-xxl-12">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header flex-wrap py-3">
                            ...
                            <div class="form-group" style="padding-top:22px;">
                                <div class="row">
                                <a href="#" class="btn btn-date-info font-weight-bold mr-2" id="kt_dashboard_daterangepicker" data-toggle="tooltip" title="Tanggal PO untuk diexport" data-placement="left">
                                ...
                                <select class="form-control" id="po_status_filter" name="po_status_filter" required>
                                    <option value="">- Status -</option>
                                    <option value="full">Fullfilled</option>
                                    <option value="unfull">Unfullfilled</option>
                                </select>
                                <a class="btn-sm btn-primary" id="export_btn">Tampilkan</a>
                                </div>
                            </div>
                        ...
                        <div class="card-body table-responsive">
                            <!--begin: Datatable-->
                            <input type="search" class="form-control  col-6" id="purchase_order_search" placeholder="Cari PO / artikel warna"/><br/>
...
<!--end::Content-->
<?php echo $__env->make('app.purchase_order_receive.purchase_order_receive_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('app._partials.js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('app.purchase_order_receive.purchase_order_receive_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('app.structure', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/purchase_order_receive/purchase_order_receive.blade.php ENDPATH**/ ?>