                ...
                <div class="row">
                    ...
                    <div class="col-4 mt-5">
                        ...
                        <select class="form-control" id="acc_id" name="acc_id" required>
                            ...
                            <?php $__currentLoopData = $data['acc_id']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>"><?php echo e($value); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    ...
                    <div class="col-4 mt-5">
                        ...
                        <select class="form-control" id="pro_id" name="pro_id" required>
                            ...
                            <?php $__currentLoopData = $data['pro_id']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>"><?php echo e($value); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
<!-- /Modal --><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/purchase_order/purchase_order_modal.blade.php ENDPATH**/ ?>