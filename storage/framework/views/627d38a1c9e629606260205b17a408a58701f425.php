                            ...
                            <table class="table table-hover table-checkable" id="Brandtb">
                                <thead class="bg-light text-dark">
                                    <tr>
                                        ...
                                        <th class="text-dark">Nama Brand</th>
                                        <th class="text-dark">Slug</th>
                                        <th class="text-dark">Deskripsi</th>
                                        <th class="text-dark">Lokal</th>
                                    </tr>
                                </thead>
                                <tbody>
...
<!--end::Content-->
<?php echo $__env->make('app.brand.brand_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('app._partials.js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('app.brand.brand_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('app.structure', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/brand/brand.blade.php ENDPATH**/ ?>