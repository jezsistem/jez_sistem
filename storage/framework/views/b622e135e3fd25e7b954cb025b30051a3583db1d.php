<script>
    $(document).ready(function() {
        ...
        var topdeals_table = $('#Topdealstb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('topdeals_datatables')); ?>",
                data : function (d) {
        ...
        var topdeals_article_table = $('#TopdealsArticletb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('topdeals_article_datatables')); ?>",
                data : function (d) {
                    d.td_id = $('#_td_id').val();
                }
            },
        ...
        var article_table = $('#ArticleListtb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('article_datatables')); ?>",
                data : function (d) {
        ...
        $(document).delegate('#check_article_btn', 'click', function() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                url: "<?php echo e(url('add_topdeals')); ?>",
                success: function(r) {
                    if (r.status == '200') {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        data: {id:id},
                        dataType: 'json',
                        url: "<?php echo e(url('delete_topdeals')); ?>",
                        success: function(r) {
                            if (r.status == '200') {
...
</script><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/topdeal/topdeal_js.blade.php ENDPATH**/ ?>