<script>
    ...
    function loadStartEnd() {
        $.ajax({
            type: "GET",
            dataType: 'html',
            url: "<?php echo e(url('reload_start_bin')); ?>",
            success: function(r) {
                $("#start").html(r);
            }
        });
        $.ajax({
            type: "GET",
            dataType: 'html',
            url: "<?php echo e(url('reload_end_bin')); ?>",
            success: function(r) {
                $("#end").html(r);
            }
        });
    ...
    function saveMutation(pls_id, index, pst_id, pls_qty)
    {
        ...
        $.ajax({
            ...
            dataType: 'json',
            url: "<?php echo e(url('sv_mutation_v2')); ?>",
            success: function(r) {
                if (r.status == '200'){
    ...
    $('#CancelBtn').on('click', function() {
        ...
        if (confirm('Apakah anda yakin untuk menghapus data import?')) {
            fetch('<?php echo e(url('cancel_import')); ?>', {
                method: 'DELETE',
                headers: {
    ...
    $('#f_import').on('submit' , function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(url('stock_location_import')); ?>",
            data: formData,
            dataType: 'json',
            cache:false,
            contentType: false,
    ...
    $(document).ready(function() {
        ...
        start_bin_table = $('#StartBintb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('start_bin_datatables')); ?>",
                data : function (d) {
        ...
        end_bin_table = $('#EndBintb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('end_bin_datatables')); ?>",
                data : function (d) {
        ...
        var bin_history_table = $('#BinHistorytb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('bin_history_datatables')); ?>",
                data : function (d) {
        ...
        $(document).delegate('#export_btn', 'click', function(e) {
            ...
            window.location.href = "<?php echo e(url('history_setup_export')); ?>?&st_id="+st_id+"&date="+date+"";
...
</script><?php /**PATH /home/sistem.jez.co.id/public_html/resources/views/app/product_location_setup_v2/product_location_setup_v2_js.blade.php ENDPATH**/ ?>