<script>
    ...
    $(document).ready(function() {
        ...
        var target_table = $('#Targettb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('target_datatables')); ?>",
                data : function (d) {
        ...
        var target_detail_table = $('#TargetDetailtb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('target_detail_datatables')); ?>",
                data : function (d) {
                    d.search = $('#target_search').val();
                    d.tr_id = $('#tr_id').val();
                }
        ...
        $('#tr_date').on('change', function() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                url: "<?php echo e(url('check_exists_target')); ?>",
                success: function(r) {
                    if (r.status == '200') {
        ...
        $('#save_target_detail_btn').on('click', function() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                url: "<?php echo e(url('sv_target_detail')); ?>",
                success: function(r) {
                    if (r.status == '200'){
        ...
        $('#f_import').on('submit', function(e) {
            ...
            $.ajax({
                type:'POST',
                url: "<?php echo e(url('sv_target_detail_import')); ?>",
                data: formData,
				dataType: 'json',
                cache:false,
                contentType: false,
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        data: {_str_id:str_id},
                        dataType: 'json',
                        url: "<?php echo e(url('delete_sub_target')); ?>",
                        success: function(r) {
                            if (r.status == '200'){
        ...
        $(document).delegate('.edit_amount', 'change', function(){
            ...
            $.ajax({
                ...
                dataType: 'json',
                url: "<?php echo e(url('edit_target')); ?>",
                success: function(r) {
                    if (r.status == '200'){
...
</script><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/target/target_js.blade.php ENDPATH**/ ?>