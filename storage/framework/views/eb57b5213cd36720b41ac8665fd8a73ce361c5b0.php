<script>
    ...
    $(document).ready(function() {
        ...
        var cross_order_table = $('#CrossOrdertb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('cross_order_datatables')); ?>",
                data : function (d) {
        ...
        var confirmation_table = $('#Confirmationtb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('confirmation_datatables')); ?>",
                data : function (d) {
                    d.pt_id = $('#pt_id').val();
                }
            },
        ...
        var detail_table = $('#Detailtb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('detail_datatables')); ?>",
                data : function (d) {
                    d.pt_id = $('#pt_id').val();
                }
            },
        ...
        $(document).delegate('#ready_check', 'click', function() {
            ...
            $.ajax({
                ...
                data: {_ptd_id:ptd_id},
                dataType: 'json',
                url: "<?php echo e(url('sv_cross_status')); ?>",
                success: function(r) {
                    if (r.status == '200'){
        ...
        $(document).delegate('#note', 'change', function() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                url: "<?php echo e(url('sv_cross_note')); ?>",
                success: function(r) {
                    if (r.status == '200'){
                        toast("Berhasil", "Berhasil mengubah status", "success");
                        confirmation_table.draw(false);
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        data: {_pt_id:pt_id},
                        dataType: 'json',
                        url: "<?php echo e(url('sv_cross_order')); ?>",
                        success: function(r) {
                            if (r.status == '200'){
        ...
        $(document).delegate('#print_btn', 'click', function() {
            ...
            $.ajax({
                ...
                data: {_pt_id:pt_id},
                dataType: 'json',
                url: "<?php echo e(url('print_cross_invoice')); ?>",
                success: function(r) {
                    if (r.status == '200'){
                        var win = window.open('<?php echo e(url('/')); ?>/cross_invoice/'+r.invoice, '_blank');
                        if (win) {
                            win.focus();
                        } else {
        ...
        $(document).delegate('#waybill_tracking_btn', 'click', function() {
            ...
            $.ajax({
                type:'POST',
                url: "<?php echo e(url('waybill_tracking')); ?>",
        ...
        $('#f_shipping_number').on('submit', function(e) {
            ...
            $.ajax({
                type:'POST',
                url: "<?php echo e(url('shipping_number_save')); ?>",
                data: formData,
				dataType: 'json',
                cache:false,
                contentType: false,
...
<?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/cross_order/cross_order_js.blade.php ENDPATH**/ ?>