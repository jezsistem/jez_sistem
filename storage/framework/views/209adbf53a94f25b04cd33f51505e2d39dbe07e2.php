        ...
        <center class="content">
            <center>
                ...
                <div class="title" style="margin-top: 20px;">
                    <strong><?php echo e($row->st_name); ?></strong><br/>
                    <?php echo e($row->st_address); ?><br/>
                    <?php echo e($row->st_phone); ?><br/><br/>
                    Jersey Zone<br/>
                    www.jez.co.id
                </div>
                ...
                <div class="head-desc">
                    <div class="date">
                        ...
                        <?php echo e(\Carbon\Carbon::parse($row->pos_created)->translatedFormat('d F Y')); ?><br/>
                        Kasir<br/>
                        Customer<br/>
                        Pembayaran
                    </div>
                    <div class="user">
                        <?php echo e(\Carbon\Carbon::parse($row->pos_created)->translatedFormat('H:i')); ?><br/>
                        <?php
                            $name = $row->u_name;
                            echo ucwords(strtolower($name))
                        ?> <br>
                        <?php echo e($row->cust_name); ?><br>
                        <?php echo e($row->pm_name); ?>

                        <?php if(!empty($row->pm_name_partial)): ?>
                            & <?php echo e($row->pm_name_partial); ?>
                    ...
                    <table class="transaction-table" cellspacing="0" cellpadding="0">
                        ...
                        <?php $__currentLoopData = $row->subitem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $srow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr style="margin-bottom:15px;">
                                ...
                                <?php if(!empty($srow->pos_td_description) AND $srow->pos_td_qty > 1): ?>
                                    <td class="qty" style="width: 1px;"><?php echo e($srow->pos_td_description); ?></td>
                                <?php else: ?>
                                    <td class="qty"><?php echo e($srow->pos_td_qty); ?>x</td>
                                    <td class="sell-price">
                                        <?php if(!empty($srow->pos_td_discount_number) || $srow->pos_td_discount_number != 0): ?>
                                            <s><?php echo e(\App\Libraries\CurrencyFormatter::formatToIDR($srow->productStock->ps_price_tag)); ?></s>
                                            <br>
                                        <?php endif; ?>


                                            <?php if(!empty($srow->pos_td_discount_number)): ?>
                                                <span>(-<?php echo e(\App\Libraries\CurrencyFormatter::formatToIDR($srow->pos_td_discount_number)); ?>)</span>
                                            <?php endif; ?>
                                ...
                                <td class="final-price">
                                    <?php echo e(\App\Libraries\CurrencyFormatter::formatToIDR($srow->pos_td_sell_price)); ?>
                        ...
                        <tr>
                            ...
                            <td class="final-price">
                                        ...
                                        <?php if(!empty($total_discount)): ?>
                                                <?php echo e(number_format($total_discount)); ?>
                        ...
                        <tr>
                            ...
                            <td class="final-price">
                                        <span style="float:right;">
                                        <?php echo e(\App\Libraries\CurrencyFormatter::formatToIDR($total_price)); ?>
                        ...
                        <tr>
                            ...
                            <td class="final-price">
                                        <span style="float:right;">
                                            <?php echo e(\App\Libraries\CurrencyFormatter::formatToIDR($nameset)); ?>
                        ...
                        <tr>
                            ...
                            <td class="final-price">
                                        ...
                                        <?php echo e($row->pos_cc_charge); ?> % (+ <?php echo e(\App\Libraries\CurrencyFormatter::formatToIDR(($total_price+$nameset)/100*$row->pos_cc_charge)); ?>)
                                        </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="final-price">
                                <span style="float:right;"><?php echo e(\App\Libraries\CurrencyFormatter::formatToIDR($row->pos_another_cost)); ?></span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3" class="final-price">
                            ...
                            <td class="final-price">
                                        <span style="float:right;">
                                            <?php if(!empty($total_discount)): ?>
                                                <?php echo e(\App\Libraries\CurrencyFormatter::formatToIDR((($total_price+$nameset) - ($total_discount)) - $total_voucher)); ?>

                                            <?php else: ?>
                                                <?php echo e(\App\Libraries\CurrencyFormatter::formatToIDR(($total_price+$nameset+($total_price+$nameset)/100*$row->pos_cc_charge+$row->pos_another_cost) - $total_voucher)); ?>
                        ...
                        <tr>
                            ...
                            <td class="final-price">
                                        <span style="float:right;">
                                        <?php if(!empty($row->pos_payment)): ?>
                                                <?php echo e(\App\Libraries\CurrencyFormatter::formatToIDR($row->pos_payment + $row->pos_payment_partial)); ?>

                                            <?php else: ?>
                                                <?php echo e(\App\Libraries\CurrencyFormatter::formatToIDR($total_price+$nameset+($total_price+$nameset)/100*$row->pos_cc_charge)); ?>
                        ...
                        <tr>
                            ...
                            <td class="final-price">
                                        ...
                                        <?php if(!empty($row->pos_payment)): ?>
                                                ...
                                                <?php echo e(\App\Libraries\CurrencyFormatter::formatToIDR(($row->pos_payment + $row->pos_payment_partial + $total_voucher) - (($total_price+$nameset) - ($total_discount)))); ?>
...
</html><?php /**PATH /home/sistem.jez.co.id/public_html/resources/views/app/invoice/print_invoice_offline.blade.php ENDPATH**/ ?>