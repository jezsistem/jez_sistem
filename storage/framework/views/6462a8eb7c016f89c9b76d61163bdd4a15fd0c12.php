...
<script>
    var sa_code = '<?php echo e($data['sa_code']); ?>';
    var st_id = '<?php echo e($data['st_id']); ?>';
    var pl_id = '';
    var sa_custom = '<?php echo e($data['sa_custom']); ?>';
    var manual = 0;
    var not_found = 0;
    var submit = 0;
    var scan_mode = 0;
    ...
    function loadBin(query)
    {
        if($.trim(query) != '' || $.trim(query) != null) {
            ...
            $.ajax({
                url:"<?php echo e(url('fetch_start_scan_adjustment_bin')); ?>",
                method:"POST",
    ...
    function scanned(barcode)
    {
        ...
        $.ajax({
            url:"<?php echo e(url('scan_adjustment_barcode')); ?>",
            method:"POST",
            data:data,
            dataType: 'json',
            cache:false,
    ...
    function sync()
    {
        ...
        $.ajax({
            url:"<?php echo e(url('scan_adjustment_sync')); ?>",
            method:"POST",
            data:data,
            dataType: 'json',
            cache:false,
    ...
    function loadQty()
    {
        ...
        $.ajax({
            url:"<?php echo e(url('scan_adjustment_qty')); ?>",
            method:"POST",
            data:data,
            dataType: 'json',
            cache:false,
    ...
    function playSound()
    {
        ...
        audioElement.setAttribute('src', "<?php echo e(asset('scanner/audio/beep.mp3')); ?>");
        audioElement.play();
    }
    ...
    $(document).ready(function() {
        ...
        var scan_adjustment_table = $('#SAtb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('start_scan_adjustment_datatables')); ?>",
                data : function (d) {
                    d.st_id = st_id;
                    d.pl_id = pl_id;
                    d.sa_code = sa_code;
        ...
        $(document).delegate('.edit_qty_so', 'change', function(e) {
            ...
            $.ajax({
                url:"<?php echo e(url('scan_adjustment_qty_update')); ?>",
                method:"POST",
                data:data,
                dataType: 'json',
                cache:false,
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        url: "<?php echo e(url('scan_adjustment_reset')); ?>",
                        success: function(r) {
                            if (r.status == '200'){
        ...
        $(document).on('click', '#back_btn', function(e) {
            e.preventDefault();
            window.location.href = "<?php echo e(url('scan_adjustment')); ?>";
        });
        ...
        function loadArticle(query)
        {
            if($.trim(query) != '' || $.trim(query) != null) {
                ...
                $.ajax({
                    url:"<?php echo e(url('fetch_start_scan_adjustment_article')); ?>",
                    method:"POST",
                    data:{query:query},
                    success:function(data){
                        $('#manualList').fadeIn();
        ...
        $(document).delegate('#add_manual_article', 'click', function(e) {
            ...
            $.ajax({
                url:"<?php echo e(url('scan_adjustment_manual')); ?>",
                method:"POST",
                data:data,
                dataType: 'json',
                cache:false,
        ...
        function minPlus(type, qty, sad_id)
        {
            ...
            $.ajax({
                url:"<?php echo e(url('min_plus_start_scan_adjustment')); ?>",
                method:"POST",
                data:data,
                dataType: 'json',
                cache:false,
        ...
        function loadNotFoundArticle(query)
        {
            if($.trim(query) != '' || $.trim(query) != null) {
                ...
                $.ajax({
                    url:"<?php echo e(url('fetch_start_scan_adjustment_article_barcode')); ?>",
                    method:"POST",
                    data:{query:query},
                    success:function(data){
                        $('#notFoundList').fadeIn();
...
<?php /**PATH /home/sistem.jez.co.id/public_html/resources/views/app/scan_adjustment/do_scan/do_scan_js.blade.php ENDPATH**/ ?>