...
<html lang="en">
<!--begin::Head-->
<?php echo $__env->make('app.pos.pos_head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<!--end::Head-->
<!--begin::Body-->
<body id="tc_body" class="header-fixed header-mobile-fixed subheader-enabled aside-enabled aside-fixed" style="background-color:#e2e2e2;">
    ...
    <div class="se-pre-con">
        ...
        <img class="img-fluid" src="<?php echo e(asset('pos/images')); ?>/loadergif.gif" alt="loading">
        </div>
    </div>
	<?php echo $__env->make('app.pos.pos_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	<div class="contentPOS">
		<div class="container-fluid">
			<div class="row">
				...
				<?php echo $__env->make('app.pos.pos_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
			</div>
		</div>
	</div>
<?php echo $__env->make('app.pos.pos_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('app.pos.pos_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<script>
	jQuery(function() {
...
<!--end::Body-->
</html><?php /**PATH /home/sistem.jez.co.id/public_html/resources/views/app/pos/pos.blade.php ENDPATH**/ ?>