...
<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside" style="background:#ffffff;">
    ...
    <div class="brand flex-column-auto" id="kt_brand">
        ...
        <a href="<?php echo e(url('/dashboard')); ?>" class="brand-logo">
            <img style="width:80px;" alt="Logo" src="<?php echo e(asset('logo')); ?>/LOGOJEZ.png" />
        </a>
        <!--end::Logo-->
        <!--begin::Toggle-->
...
<!--end::Aside-->
<?php /**PATH D:\88 Other\Dev\jez_sistem\resources\views/app/_partials/sidebar.blade.php ENDPATH**/ ?>