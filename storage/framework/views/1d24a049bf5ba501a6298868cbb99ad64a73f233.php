<script>
    ...
    $(document).ready(function() {
        ...
        var po_receive_table = $('#PoReceivetb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('po_receive_datatables')); ?>",
                data : function (d) {
        ...
        var po_table = $('#Potb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('po_receive_detail_datatables')); ?>",
                data : function (d) {
        ...
        $(document).delegate('#export_btn', 'click', function(e) {
            ...
            window.location.href = "<?php echo e(url('po_receive_export')); ?>?&st_id="+st_id+"&date_filter="+date_filter+"&status_filter="+status_filter+"&date="+date+"";
...
</script><?php /**PATH /home/sistem.jez.co.id/public_html/resources/views/app/report/po_receive/po_receive_js.blade.php ENDPATH**/ ?>