<script>
    ...
    $(document).ready(function() {
        ...
        var nameset_table = $('#NamesetDatatb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('nameset_datatables')); ?>",
                data : function (d) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    jQuery.ajax({
                        ...
                        dataType: 'json',
                        url: "<?php echo e(url('update_data')); ?>",
                        success: function(r) {
                            if (r.status=='200') {
                                nameset_table.draw();
...
</script><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/nameset_data/nameset_data_js.blade.php ENDPATH**/ ?>