...
<script>
    ...
    function getProductSizeBarcode(id) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            url: "<?php echo e(url('check_exists_barcode')); ?>",
            success: function(r) {
                $.ajaxSetup({
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    url: "<?php echo e(url('update_barcode')); ?>",
                    success: function(r) {
                        if (r.status == '200') {
    ...
    function getProductPriceTag(id) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            url: "<?php echo e(url('update_price_tag')); ?>",
            success: function(r) {
                if (r.status == '200') {
    ...
    function getProductSellPrice(id) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            url: "<?php echo e(url('update_sell_price')); ?>",
            success: function(r) {
                if (r.status == '200') {
    ...
    function fetchDataBasedOnSchemaId(schemaId) {
        return new Promise(function(resolve, reject) {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo e(url('reload_size_schema')); ?>",
                data: {
                    schema_id: schemaId
                },
    ...
    function getProductPurchasePrice(id) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            url: "<?php echo e(url('update_purchase_price')); ?>",
            success: function(r) {
                if (r.status == '200') {
    ...
    $(document).ready(function() {
        ...
        var product_table = $('#Producttb').DataTable({
            ...
            ajax: {
                url: "<?php echo e(url('product_datatables')); ?>",
                data: function(d) {
        ...
        function handleSchemaChange(selectedValue, id) {
            ...
            $.ajax({
                ...
                dataType: 'html',
                url: "<?php echo e(url('reload_size_schema_modal')); ?>",
                success: function(r) {
                    $('#reload_size').html(r);
        ...
        $('#Producttb tbody').on('click', 'tr td:not(:nth-child(11))', function() {
            ...
            $.ajax({
                type: "GET",
                dataType: 'html',
                url: "<?php echo e(url('pssc_reload')); ?>",
                success: function(r) {
                    $('#_pssc_id').html(r);
            ...
            $.ajax({
                ...
                dataType: 'json',
                url: "<?php echo e(url('check_product_po')); ?>",
                success: function(r) {
                    if (r.status == '200') {
        ...
        $('#article_id').on('change', function() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                url: "<?php echo e(url('check_exists_article_id')); ?>",
                success: function(r) {
                    if (r.status == '200') {
                        swal('Kode',
        ...
        $(document).delegate('#product_detail_btn', 'click', function() {
            ...
            $.ajax({
                ...
                dataType: 'html',
                url: "<?php echo e(url('product_detail')); ?>",
                success: function(r) {
...
<?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/product/product_js.blade.php ENDPATH**/ ?>