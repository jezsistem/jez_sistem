...
<script>
    ...
    $(document).ready(function() {
        ...
        function exportTable(label, date, store, division)
        {
            ...
            $.ajax({
                type:'POST',
                url: "<?php echo e(url('export_table')); ?>",
                data: data,
                cache:false,
                contentType: false,
                processData: false,
        ...
        function getSummary(date, store, division)
        {
            ...
            $.ajax({
                ...
                dataType: 'json',
                url: "<?php echo e(url('get_summaries')); ?>",
                success: function(r) {
                    if (r.status == 200){
        ...
        function loadAdminCost(label, date, store, division)
        {
            ...
            $.ajax({
                type:'POST',
                url: "<?php echo e(url('load_admin_cost')); ?>",
                data: {label:label, date:date, store:store, division:division},
                dataType: 'json',
                success: function(r) {
                    if (r.status == '200') {
...
<?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/updated_dashboard/dashboard_js.blade.php ENDPATH**/ ?>