<script>
    function reloadPendingTransfer()
    {
        $.ajax({
            type: "GET",
            dataType: 'json',
            url: "<?php echo e(url('get_pending_stf_code')); ?>",
            success: function(r) {
                if (r.stf_code != '') {
    ...
    $(document).ready(function() {
        ...
        var transfer_bin_table = $('#TransferBintb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('transfer_bin_datatables')); ?>",
                data : function (d) {
                    d.pl_id = $('#pl_id').val();
        ...
        var in_transfer_bin_table = $('#InTransferBintb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('in_transfer_bin_datatables')); ?>",
                data : function (d) {
        ...
        var transfer_history_table = $('#TransferHistorytb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('transfer_history_datatables')); ?>",
                data : function (d) {
        ...
        $('#st_id_start').on('change', function() {
            ...
            $.ajax({
                ...
                data: {_st_id:st_id},
                dataType: 'html',
                url: "<?php echo e(url('reload_transfer_bin')); ?>",
                success: function(r) {
                    $('#pl_id').html(r);
                }
            });
        ...
        $('#CancelBtn').on('click', function() {
            ...
            if (confirm('Apakah anda yakin untuk menghapus data import?')) {
                fetch('<?php echo e(url('cancel_import_transfer')); ?>', {
                    method: 'DELETE',
                    headers: {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({    
                        ...
                        dataType: 'json',
                        url: "<?php echo e(url('cancel_transfer_item')); ?>",
                        success: function(r) {
                            if (r.status == '200'){
                                transfer_bin_table.draw();
                                transfer_history_table.draw();
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({    
                        ...
                        dataType: 'json',
                        url: "<?php echo e(url('stock_transfer_done')); ?>",
                        success: function(r) {
                            if (r.status == '200'){
                                $('#stf_code').text('');
                                transfer_history_table.draw();
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({    
                        ...
                        dataType: 'json',
                        url: "<?php echo e(url('stock_transfer_exec')); ?>",
                        success: function(r) {
                            if (r.status == '200'){
                                if ($('#stf_code').text() == '') {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({    
                        ...
                        data: {inv:inv},
                        dataType: 'json',
                        url: "<?php echo e(url('stock_transfer_draft')); ?>",
                        success: function(r) {
                            if (r.status == '200'){
                                $('#stf_code').text('');
                                in_transfer_bin_table.draw();
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({    
                        ...
                        data: {inv:inv},
                        dataType: 'json',
                        url: "<?php echo e(url('stock_transfer_cancel')); ?>",
                        success: function(r) {
                            if (r.status == '200'){
                                $('#stf_code').text('');
                                transfer_bin_table.draw();
        ...
        $('#f_import').on('submit' , function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(url('stock_transfer_import')); ?>",
                data: formData,
                dataType: 'json',
                cache:false,
                contentType: false,
...
</script><?php /**PATH /home/sistem.jez.co.id/public_html/resources/views/app/stock_transfer/stock_transfer_js.blade.php ENDPATH**/ ?>