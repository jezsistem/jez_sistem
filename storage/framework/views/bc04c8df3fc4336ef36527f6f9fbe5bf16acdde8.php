<script>
    ...
    $(document).ready(function() {
        ...
        var po_approval_table = $('#APtb').DataTable({
            ...
            ajax: {
                url: "<?php echo e(url('poc_datatables')); ?>",
                data: function(d) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        url: "<?php echo e(url('poc_update_is_paid')); ?>",
                        success: function(r) {
                            if (r.status == '200') {
...
<?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/purchase_order_receive_cod/purchase_order_receive_cod_js.blade.php ENDPATH**/ ?>