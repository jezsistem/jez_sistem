    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header bg-light">
                <h5 class="modal-title text-dark" id="exampleModalLabel">Web Qty Exception</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-dark font-weight-bold" id="save_qty_exception_btn">Simpan</button>
            </div>
            </form>
        </div>
    </div>
</div>
<!-- /Modal --><?php /**PATH /home/sistem.jez.co.id/public_html/resources/views/app/qty_exception/qty_exception_modal.blade.php ENDPATH**/ ?>