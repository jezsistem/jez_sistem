                ...
                <div class="col-lg-12 col-xxl-12">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body table-responsive">
                            <input type="search" class="form-control bg-light col-4" id="po_receive_search" placeholder="Cari No PO"/><br/>
                            <table class="table table-hover table-checkable" id="PoReceivetb">
                                <thead class="bg-light text-dark">
                                    <tr>
                                        <th class="text-dark">No</th>
                                        <th class="text-dark" style="white-space:nowrap;">No PO</th>
                                        <th class="text-dark" style="white-space:nowrap;">Store</th>
                                        <th class="text-dark" style="white-space:nowrap;">Tgl PO</th>
                                        <th class="text-dark" style="white-space:nowrap;">Tgl Terima</th>
...
<!--end::Content-->
<?php echo $__env->make('app.report.po_receive.po_receive_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('app._partials.js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('app.report.po_receive.po_receive_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('app.structure', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sistem.jez.co.id/public_html/resources/views/app/report/po_receive/po_receive.blade.php ENDPATH**/ ?>