                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Pilih template yang sudah di download dan diisi
                                <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" value="<?php echo e(\Illuminate\Support\Facades\Auth::user()->st_id); ?>" name="st_id_form" id="st_id_form" disabled>
...
<!-- /Modal --><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/online_transaction/online_transaction_modal.blade.php ENDPATH**/ ?>