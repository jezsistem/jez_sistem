    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <?php if($data['sa_custom'] == '1'): ?>
                <?php if(!empty($data['bin_custom'])): ?>
                <?php $__currentLoopData = $data['bin_custom']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a class="btn btn-sm btn-primary bin_custom mr-2 mb-2" data-id="<?php echo e($row->id); ?>"><?php echo e($row->pl_code); ?></a>
...
<!-- /Modal -->
<?php /**PATH /home/sistem.jez.co.id/public_html/resources/views/app/scan_adjustment/do_scan/do_scan_modal.blade.php ENDPATH**/ ?>