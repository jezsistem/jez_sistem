                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Pilih template yang sudah di download dan diisi
                                <span class="text-danger">*</span></label>
                            <input type="hidden" class="form-control" value="<?php echo e(\Illuminate\Support\Facades\Auth::user()->st_id); ?>" name="st_id_form" id="st_id_form" disabled>
...
<!-- /Modal --><?php /**PATH /home/dev.jez.co.id/public_html/resources/views/app/online_transaction/online_transaction_modal.blade.php ENDPATH**/ ?>