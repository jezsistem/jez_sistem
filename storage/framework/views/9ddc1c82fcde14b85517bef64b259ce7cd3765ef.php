            ...
            <div class="shop-profile bg-primary">
                <div class="media">
                    <div class="media-body ml-3 mt-3">
                        <h3 class="title font-weight-bold text-white"><?php echo e($data['store']->st_name); ?></h3>
...
</div><?php /**PATH /home/sistem.jez.co.id/public_html/resources/views/app/pos/pos_sidebar.blade.php ENDPATH**/ ?>