    ...
    <div class="card card-xl-stretch mb-5 mb-xl-12">
        ...
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">Cash-Credit Assets</span>
        ...
        <div class="card-body py-3">
            ...
            <div class="table-responsive">
                <!--begin::Table-->
                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="cc_assets_table">
                    <!--begin::Table head-->
                    <thead>
...
<!--end::Col-->
<script>
    var table = jQuery('#cc_assets_table').DataTable({
        destroy: true,
        processing: true,
        serverSide: true,
        responsive: false,
        ...
        ajax: {
            url : "<?php echo e(url('get_cc_assets')); ?>",
            data : function (d) {
...
<?php /**PATH C:\laragon\www\jez_sistem\resources\views/app/updated_dashboard/_load_cc_assets.blade.php ENDPATH**/ ?>