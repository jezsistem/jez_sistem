                    ...
                    <div class="card-body">
                        <div class="form-group mb-1 pb-10">
                            ...
                            <input type="password" class="form-control" id="u_secret_code" name="u_secret_code"
                                   value="<?php echo e($data['user']->u_secret_code); ?>" autocomplete="off" required/>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
...
<!-- /Modal --><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/dashboard/helper/dashboard_modal.blade.php ENDPATH**/ ?>