...
<script>
    ...
    function reloadArticleDetail(id) {
        ...
        $.ajax({
            ...
            url: "<?php echo e(url('check_po_detail')); ?>",
            success: function(r) {
    ...
    function poPurchasePrice(id, index, poad_id, po_id) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            url: "<?php echo e(url('poad_save_qty_total')); ?>",
            success: function(r) {
                if (r.status == '200') {
    ...
    function discount(id) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            url: "<?php echo e(url('poa_save_discount')); ?>",
            success: function(r) {
                if (r.status == '200') {
                    toast('Disimpan', 'Informasi berhasil disimpan', 'success');
                } else {
    ...
    function reloadPoTotalPrice(id) {
        ...
        $.ajax({
            ...
            url: "<?php echo e(url('reload_po_detail')); ?>",
            success: function(r) {
                if (r.status == '200') {
    ...
    $(document).ready(function() {
        ...
        $('#st_id').on('change', function() {
            ...
            $.ajax({
                ...
                url: "<?php echo e(url('po_choose_store')); ?>",
                success: function(r) {
                    if (r.status == '200') {
        ...
        $('#ps_id').on('change', function() {
            ...
            $.ajax({
                ...
                url: "<?php echo e(url('po_choose_supplier')); ?>",
                success: function(r) {
                    if (r.status == '200') {
        ...
        $('#stkt_id').on('change', function() {
            ...
            $.ajax({
                ...
                url: "<?php echo e(url('po_choose_stock_type')); ?>",
                success: function(r) {
                    if (r.status == '200') {
        ...
        $('#tax_id').on('change', function() {
            ...
            $.ajax({
                ...
                url: "<?php echo e(url('po_choose_tax')); ?>",
                success: function(r) {
                    if (r.status == '200') {
        ...
        $('#acc_id').on('change', function() {
            ...
            $.ajax({
                ...
                url: "<?php echo e(url('po_choose_payment')); ?>",
                success: function(r) {
                    if (r.status == '200') {
        ...
        $('#po_description').on('change', function() {
            ...
            $.ajax({
                ...
                url: "<?php echo e(url('po_description')); ?>",
                success: function(r) {
                    if (r.status == '200') {
        ...
        $('#shipping_cost').on('change', function() {
            ...
            $.ajax({
                ...
                url: "<?php echo e(url('po_shipping_cost')); ?>",
                success: function(r) {
                    if (r.status == '200') {
            ...
            swal({
                ...
                if (willSend) {
                    $.ajax({
                        ...
                        url: "<?php echo e(url('check_pre_order_purchase_order')); ?>",
                        success: function(r) {
                            console.log(r);
                            if (r.status == '200') {
        ...
        $('#f_upload_invoice_image').on('submit', function(e) {
         ...
         $('#f_upload_transfer_image').on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(url('po_transfer_image')); ?>",
                data: formData,
                dataType: 'json',
                cache: false,
                contentType: false,
        ...
        $(document).delegate('#ExportArticleData', 'click', function(e) {
            ...
            window.location.href = "<?php echo e(url('po_article_export')); ?>?po_id=" + po_id + "&st_id=" + st_id;
        });
    });
</script>
<?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/purchase_order/purchase_order_js.blade.php ENDPATH**/ ?>