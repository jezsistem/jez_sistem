...
<script>
    var table = jQuery('#nett_sales_table').DataTable({
        ...
        ajax: {
            url : "<?php echo e(url('get_cross_nettsales')); ?>",
            data : function (d) {
...
<?php /**PATH /home/sistem.jez.co.id/public_html/resources/views/app/updated_dashboard/_load_cross_sales.blade.php ENDPATH**/ ?>