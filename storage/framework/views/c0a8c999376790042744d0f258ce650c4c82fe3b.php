        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a href="https://report.jez.co.id" target="_blank" class="btn btn-dark mr-2" id="urban_panel_btn"
                        style="font-weight:500;">Report Dashboard</a>
                    <input type="hidden" id="urban_panel" value="" />
                    <a class="btn btn-date-info font-weight-bold" id="kt_dashboard_daterangepicker" data-toggle="tooltip"
                        ...
                        <div class="card card-custom card-stretch gutter-b" style="border-radius:.625rem;">
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div class="text-right col-6 px-0">
                                        <a class="font-weight-bold fs-9 btn" id="nett_sales_label"
                                            ...
                                            <img src="<?php echo e(asset('logo/printer1.png')); ?>" alt="checklist"
                                ...
                                <center class="button-show_ns pt-10">
                                    ...
                                    <img class="d-none" id="ns_loading" src="<?php echo e(asset('upload/loading/loading.gif')); ?>"
                        ...
                        <div class="card card-custom card-stretch gutter-b" style="border-radius:.625rem;">
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div class="text-right col-6 px-0">
                                        <span class="font-weight-bold fs-9 btn" id="profit_label"
                                            ...
                                            </span><img src="<?php echo e(asset('logo/printer1.png')); ?>" alt="checklist"
                                ...
                                <center class="button-show_pr pt-10">
                                    ...
                                    <img class="d-none" id="pr_loading" src="<?php echo e(asset('upload/loading/loading.gif')); ?>"
                                        style="width:20%; padding-bottom:20px;" />
                                </center>
                        ...
                        <div class="card card-custom card-stretch gutter-b" style="border-radius:.625rem;">
                            ...
                            <div class="card-body">
                                ...
                                <center class="button-show_cns pt-20">
                                    ...
                                    <img class="d-none" id="cns_loading" src="<?php echo e(asset('upload/loading/loading.gif')); ?>"
                                        style="width:20%; padding-bottom:20px;" />
                                </center>
                        ...
                        <div class="card card-custom card-stretch gutter-b" style="border-radius:.625rem;">
                            ...
                            <div class="card-body">
                                ...
                                <center class="button-show_cpr pt-20">
                                    ...
                                    <img class="d-none" id="cpr_loading" src="<?php echo e(asset('upload/loading/loading.gif')); ?>"
                                        style="width:20%; padding-bottom:20px;" />
                                </center>
                        ...
                        <div class="card card-custom card-stretch gutter-b" style="border-radius:.625rem;">
                            ...
                            <div class="card-body">
                                ...
                                <center class="button-show_pc pt-20">
                                    ...
                                    <img class="d-none" id="pc_loading" src="<?php echo e(asset('upload/loading/loading.gif')); ?>"
                                        style="width:20%; padding-bottom:20px;" />
                                </center>
                        ...
                        <div class="card card-custom card-stretch gutter-b" style="border-radius:.625rem;">
                            ...
                            <div class="card-body">
                                ...
                                <center class="button-show_a pt-20">
                                    ...
                                    <img class="d-none" id="a_loading" src="<?php echo e(asset('upload/loading/loading.gif')); ?>"
                                        style="width:20%; padding-bottom:20px;" />
                                </center>
                        ...
                        <div class="card card-custom card-stretch gutter-b" style="border-radius:.625rem;">
                            ...
                            <div class="card-body">
                                ...
                                <center class="button-show_ca pt-20">
                                    ...
                                    <img class="d-none" id="ca_loading" src="<?php echo e(asset('upload/loading/loading.gif')); ?>"
                                        style="width:20%; padding-bottom:20px;" />
                                </center>
                                </center>
                        ...
                        <div class="card card-custom card-stretch gutter-b" style="border-radius:.625rem;">
                            ...
                            <div class="card-body">
                                ...
                                <center class="button-show_d pt-20">
                                    ...
                                    <img class="d-none" id="d_loading" src="<?php echo e(asset('upload/loading/loading.gif')); ?>"
                                        style="width:20%; padding-bottom:20px;" />
                                </center>
...
<?php echo $__env->make('app.structure', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\jez\jez_sistem\resources\views/app/dashboard/dashboard.blade.php ENDPATH**/ ?>