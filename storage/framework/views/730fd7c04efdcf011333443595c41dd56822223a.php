...
<script>
    ...
    $(document).ready(function() {
        ...
        var user_shift_table = $('#UserShiftTb').DataTable({
            ...
            ajax: {
                url: "<?php echo e(url('report_current_shift_datatables')); ?>",
                type: 'GET',
                data: function (d) {
        ...
        $('#UserShiftTb tbody').on('click', 'tr', function () {
            ...
            $.ajax({
                url: "<?php echo e(url('current_shift_detail')); ?>",
                type: 'post',
                data: {
                    id: data,
                    ...
                    // end_time: end_time,
                    total_pos_real_price: total_pos_real_price,
                ...
                success: function (response) {
                    ...
                    $('#userShiftDetailSoldBtn').on('click', function () {
                        ...
                        $.ajax({
                            url: "<?php echo e(url('report_shift_product_sold')); ?>",
                            type: 'post',
                            data: {
                                id: data,
                                start_time_original: start_time_original,
                    ...
                    $('#userShiftDetailRefundBtn').on('click', function () {
                        ...
                        $.ajax({
                            url: "<?php echo e(url('report_shift_product_refund')); ?>",
                            type: 'post',
                            data: {
                                id: data,
                                start_time_original: start_time_original,
...
</script><?php /**PATH /home/jezpro.id/public_html/resources/views/app/report/current_shift/current_shift_js.blade.php ENDPATH**/ ?>