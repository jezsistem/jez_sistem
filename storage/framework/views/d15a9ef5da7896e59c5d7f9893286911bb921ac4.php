 ...
 // Membuat format nama file dengan format tanggal/bulan/tahun-jam
    ...
    function cabangSummary(st_id, stt_id, date)
    {
        ...
        $.ajax({
            ...
            dataType: 'json',
            url: "<?php echo e(url('cabang_summary')); ?>",
            success: function(r) {
                if (r.status == '200'){
    ...
    $(document).ready(function() {
        ...
        var hbhj_table = $('#HBHJtb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('check_hb_hj')); ?>",
                data : function (d) {
        ...
        var invoice_report_table = $('#InvoiceReporttb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('invoice_report_datatables')); ?>",
                data : function (d) {
        ...
        var article_report_table = $('#ArticleReporttb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('article_report_datatables')); ?>",
                data : function (d) {
        ...
        var cross_report_tb = $('#CrossReporttb').DataTable({
            ...
            ajax: {
                url : "<?php echo e(url('article_cross_report_datatables')); ?>",
                data : function (d) {
                    d.search = $('#article_report_search').val();
                    d.stt_id = $('#stt_id').val();
                    d.st_id = $('#st_id_filter').val();
        ...
        $(document).delegate('#export_btn', 'click', function(e) {
            ...
            window.location.href = "<?php echo e(url('sales_export')); ?>?type="+type+"&date="+date+"&stt_id="+stt_id+"&st_id="+st_id+"&dp_id="+dp_id+"";
        });
...
</script><?php /**PATH C:\laragon\www\JEZ_S7\JEZ sistem\jez_sistem\resources\views/app/report/sales_report/sales_report_js.blade.php ENDPATH**/ ?>