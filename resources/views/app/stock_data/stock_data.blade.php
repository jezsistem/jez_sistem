                        ...
                        <div class="card-header flex-wrap py-3" style="background:#efefef;">
                            <div class="card-toolbar col-12 mt-4">
                                ...
                                <div class="dropdown dropdown-inline col-xl-4 col-xxl-4 mt-2">
                                    ...
                                    @endif
                                    <button style="white-space: nowrap;" type="button" class="btn btn-primary font-weight-bolder mb-2" id="aging_btn" aria-haspopup="true" aria-expanded="false">
                                    <span class="svg-icon svg-icon-md">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24" />
                                    ...
                                    <button style="white-space: nowrap;" type="button" class="btn btn-primary font-weight-bolder mb-2" id="scan_mode_btn">
                                    <span class="svg-icon svg-icon-md">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24" />
