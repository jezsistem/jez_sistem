                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <div class="text-dark font-weight-bold font-size-h5" id="pending-requests">
                                            {{ $leaveRequests->where('lr_status', 'pending')->count() }}</div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <div class="text-dark font-weight-bold font-size-h5" id="approved-requests">
                                            {{ $leaveRequests->where('lr_status', 'approved')->count() }}</div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <div class="text-dark font-weight-bold font-size-h5" id="rejected-requests">
                                            {{ $leaveRequests->where('lr_status', 'rejected')->count() }}</div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <select class="form-control" id="status" name="status">
                                                <option value=""
                                                    {{ $status === '' && $status !== null ? 'selected' : '' }}>All Status
                                                </option>
                                                <option value="pending"
                                                    {{ $status === null || $status == 'pending' ? 'selected' : '' }}>
                                                    Pending</option>
                                ...
                                <div class="card-toolbar d-flex justify-content-between w-100">
                                    <div class="d-flex align-items-center">
                                        <input type="search" class="form-control" style="width: 300px;"
                                            id="leave_request_search" placeholder="Search" />
                                    </div>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Button-->
                                        <a href="{{ route('leave-requests.summary-report') }}"
                                            ...
                                            <span class="svg-icon svg-icon-md">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <g stroke="none" stroke-width="1" fill="none"
                                                        ...
                                                        <path
                                                            d="M9,12 L11,12 L11,10 L9,10 L9,12 Z M9,16 L11,16 L11,14 L9,14 L9,16 Z M9,8 L11,8 L11,6 L9,6 L9,8 Z M17,12 L19,12 L19,10 L17,10 L17,12 Z M17,16 L19,16 L19,14 L17,14 L17,16 Z M17,8 L19,8 L19,6 L17,6 L17,8 Z M5,6 L7,6 L7,18 L5,18 L5,6 Z M13,6 L15,6 L15,18 L13,18 L13,6 Z"
                                                            fill="#000000" />
                                                    </g>
                                                </svg>
                                                <!--end::Svg Icon-->
