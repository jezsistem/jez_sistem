                    ...
                    <table class="table table-bordered table-hover table-checkable" id="reactionsTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap">
                                    <a href="#" class="btn btn-sm btn-clean btn-icon" onclick="editReaction({{ $reaction->id }}, '{{ $reaction->name }}', '{{ $reaction->emoji }}', '{{ $reaction->color }}', {{ $reaction->sort_order }}, {{ $reaction->hide_announcement ? 'true' : 'false' }}, '{{ $reaction->status }}')" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="#" class="btn btn-sm btn-clean btn-icon" onclick="deleteReaction({{ $reaction->id }})" title="Delete">
...
(function() {
    function initializePage() {
        console.log('Initializing reactions page...');
