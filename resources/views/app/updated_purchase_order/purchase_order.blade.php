...
<div class="space-y-6 pb-12">
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 bg-white rounded-lg border border-gray-200 p-4">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Kelola purchase order</p>
        </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-5">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="relative">
                ...
                <input type="search" id="purchase_order_search" class="block w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Cari Purchase Order">
            </div>
            <div>
            ...
            <div>
                ...
                <select id="filter_delivery_note" class="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <option value="1">Ada Delivery Note</option>
                    <option value="0">Tidak Ada Delivery Note</option>
                </select>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-5">
        <div class="datatable-container overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200" id="PurchaseOrdertb">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">User Receive</th>
...
@push('styles')
@include('app.updated_purchase_order.purchase_order_css')
@endpush

@push('scripts')
@include('app.updated_purchase_order.purchase_order_js')
@endpush

@include('app.updated_purchase_order.purchase_order_modal')
@endsection
