    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div id="loader_dashboard">
                <img src="{{ asset('pos') }}/jez.gif" alt="loading">
            </div>
            <!--end::Loader-->
            <!--end::Row-->
            <!--end::Dashboard-->
