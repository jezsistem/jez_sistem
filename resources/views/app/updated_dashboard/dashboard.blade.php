...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <!--begin::Daterange-->
                <a href="{{ url('dashboard') }}" class="d-flex align-items-center btn btn-inventory mr-2"><i class="ki-outline ki-arrow-up-left pr-0 fs-3"><i class="path1"></i><i class="path2"></i></i>
                Dashboard V1</a>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="mt-2">
                                    @foreach ($data['st_id'] as $key => $value)
                                        <a class="btn btn-sm btn-light-primary col-3 st_selection w-20" data-id="{{ $key }}">{{ $value }}</a>
                                    @endforeach
                                </div>
                             </div>
                            <!--end::Timeline-->
