        ...
        <div class="modal-content">
            <form id="f_scan_adjustment" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-1 pb-1">
                            ...
                            <input type="text" class="form-control" id="sa_description" name="sa_description"
                                required />
                        </div>
                        ...
                        <div class="d-none" id="custom_panel">
                            ...
                            <div class="form-group mb-1 pb-1">
                                ...
                                <input type="text" class="form-control" id="sub_category_input"
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger font-weight-bold" id="delete_scan_adjustment_btn"
                        style="display:none;">Hapus</button>
                    <button type="submit" class="btn btn-dark font-weight-bold"
                        id="save_scan_adjustment_btn">Simpan</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="BrandModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body table-responsive">
                <input type="search" class="form-control form-control-sm col-12" id="custom_brand_search"
...
<div class="modal fade" id="SubCategoryModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body table-responsive">
                <input type="search" class="form-control form-control-sm col-12" id="custom_psc_search"
