...
@section('content')
                    ...
                    <div class="col-lg-12 col-xxl-12">
                        ...
                        <div class="card card-custom gutter-b">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="mr-2">
                                        <button type="button"
                                            ...
                                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="user_shift_excel_btn">
                            ...
                            <div class="card-body table-responsive">
                                ...
                                <div class="row">
                                    <div class="col-9">
                                        <input type="search" class="form-control" id="user_shift_search"
                                            placeholder="Cari Nama Shift" /><br />
    ...
    @include('app.report.shift.shift_js')
    @include('app.report.shift.shift_modal')
@endSection()
