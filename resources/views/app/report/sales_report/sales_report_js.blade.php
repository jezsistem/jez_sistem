    ...
    $(document).ready(function() {
        ...
        var invoice_report_table = $('#InvoiceReporttb').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'pos_unique_code',
                    name: 'pos_unique_code'
                },
                {
                    data: 'pos_admin_cost',
                    name: 'pos_admin_cost',
                ...
                {
                    data: 'pos_card_number',
                    name: 'pos_card_number'
                },
                {
                    data: 'pos_ref_number',
                    name: 'pos_ref_number'
                ...
                {
                    data: 'pos_card_number_two',
                    name: 'pos_card_number_two'
                },
                {
                    data: 'pos_ref_number_two',
                    name: 'pos_ref_number_two'
                },
                {
                    data: 'pos_paid_dp',
                    name: 'pos_paid_dp'
