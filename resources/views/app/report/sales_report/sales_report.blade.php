                    ...
                    <div class="col-lg-12 col-xxl-12">
                        ...
                        <div class="card card-custom gutter-b">
                            <div class="card-header h-auto align-items-center justify-content-between">
                                ...
                                <div class="alert alert-custom alert-white alert-shadow fade show gutter-b bg-primary"
                                    role="alert">
                                ...
                                <div class="alert alert-custom alert-white alert-shadow fade show gutter-b bg-primary"
                                    role="alert">
                                    <a href="#" class="btn btn-sm btn-success font-weight-bold mr-2 col-12"
                                        id="sales_summary_btn" style="color:black;">
                                        Summary Penjualan
                                    </a>
                                </div>
                                <!--end::Title-->
                            ...
                            <div class="card-body table-responsive">
                                <!--begin: Datatable-->
                                <input type="search" class="form-control  col-6" id="invoice_report_search"
                                    placeholder="Cari invoice / customer / user / divisi" /><br />
                                <a class="btn btn-primary ml-auto mr-2" data-type="invoice" id="export_btn">Export
                                    Excel</a><br />
                                <center>
                                    <h3 class="btn-sm btn-primary col-3">By Invoice</h3>
                                </center>
                            ...
                            <div class="card-body table-responsive">
                                ...
                                <div class="row">
                                    <input type="search" class="form-control  col-6" id="article_report_search"
                                        placeholder="Cari artikel" />
                                    <a class="btn btn-primary ml-auto mr-2" data-type="article" id="export_btn">Export
                                        Excel</a>
                                    <span id="pt_id_filter_label" class=""> </span><br />
                                </div><br />
                                <center>
                                    <h3 class="btn-sm btn-primary col-3">By Artikel</h3>
                                </center>
