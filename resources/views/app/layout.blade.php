            ...
            <div class="sidebar-menu">
                <ul class="menu">
                    <li class="sidebar-title">Menu</li>
                        <li class="sidebar-item {{ request()->is('pos_v2') ? 'active' : '' }}">
                            <a href="/pos_v2" class="sidebar-link">
                                <i class="bi bi-grid-fill"></i>
                                <span>Dashboard</span>
                            </a>
    
                            <li class="sidebar-item has-sub {{ request()->is('posv2/masterdata*') ? 'active' : '' }}">
                            ...
                            <li class="sidebar-item has-sub {{ request()->is('posv2/user*') ? 'active' : '' }}">
                                <a href="user" class="sidebar-link">
                                    <i class="bi bi-people-fill"></i>
                                    <span>User</span>
                                </a>
                                <ul class="submenu submenu-open" style="--submenu-height: 86px;">
                                    <li class="submenu-item {{ request()->routeIs('posv2.user.datauser-posv2') ? 'active' : '' }}">
                                        <a href="{{ route('posv2.user.datauser-posv2') }}">Data User</a>
                                    </li>
                                    <li class="submenu-item ">
                                ...
                                <div class="user-menu d-flex">
                                    ...
                                    <div class="user-img d-flex align-items-center">
                                        <div class="avatar avatar-md">
                                            <img src="{{ asset('assetsnew/assets/compiled/jpg/1.jpg') }}" alt="Image">
