<!-- Modal-->
<div class="modal fade" id="StockTransferDataModal" rrole="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
        ...
        <div class="modal-content">
            <div class="modal-header bg-light">
                ...
                <div class="dropdown dropdown-inline mr-2">
                    <a type="button" class="btn btn-dark font-weight-bolder" id="ExportBtn" aria-haspopup="true"
                        aria-expanded="false">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" name="importFile" id="importFile"
                                accept=".csv" required />
                            <input type="hidden" id="import_stf_id" name="import_stf_id" value="">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
