                        ...
                        <div class="card card-custom gutter-b">
                            <div class="card-header flex-wrap py-3">
                                <div class="card-toolbar">
                                            ...
                                            <ul class="navi flex-column navi-hover py-2">
                                                ...
                                                <li class="navi-item">
                                                    <a href="#" class="navi-link">
                                                        ...
                                                        <span id="rekomendasi_promo_excel_btn"></span>
                                                    </a>
                                                </li>
                                                <a href="#" class="navi-link">
                                                        <span class="navi-icon">
                                    ...
                                    <!--end::Dropdown-->
                                    <!--begin::Button-->
                                    <a href="#" class="btn btn-dark font-weight-bolder" id="add_rekomendasi_promo_btn">
                            ...
                            <div class="card-body table-responsive">
                                ...
                                <div class="d-flex align-items-center">
                                    <input type="search" class="form-control col-6" id="rekomendasi_promo_search"
                                           placeholder="Cari Rekomendasi Promo"/>
                                    <a href="#" class="btn btn-date-info font-weight-bold ml-2" id="kt_dashboard_daterangepicker" 
                                       data-toggle="tooltip" title="Article Promo Start Date" data-placement="left">
                                        ...
                                        <input type="hidden" id="rekomendasi_promo_end_date"/>
                                    </a>
                                </div>
                                <br/>
