                ...
                <div class="p-4 md:p-5">
                    <form id="f_shift_customer">
                        ...
                        <div class="flex gap-2 mb-4" role="group">
                            <button type="button" id="start-shift-btn" class="flex-1 text-white bg-gray-900 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                                Start Shift
                            </button>
