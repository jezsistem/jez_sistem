<script>
    ...
    $(document).ready(function() {
        ...
        var invoice_table = $('#Invoicetb').DataTable({
            ...
            ajax: {
                url: "{{ url('ie_permission_invoice_datatables') }}",
                data: function(d) {
                    d.pt_id = pt_id;
                }
            },
            columns: [{
                ...
                {
                    data: 'pos_payment_partial',
                    name: 'pos_payment_partial',
                    orderable: false
                },
                {
                    data: 'admin',
            ...
            $.ajax({
                ...
                success: function(r) {
                    if (r.status == '200') {
                        ...
                        toast('Gagal',
                            'Invoice tidak ditemukan, atau sudah lewat dari 2 hari, hanya administrator yang bisa edit lebih dari 2 hari',
                            'error');
                    }
                    invoice_table.draw();
                    detail_table.draw();
                    ...
                    $.ajax({
                        ...
                        success: function(r) {
                            if (r.status == 200) {
                                ...
                                // Gagal dari response 200 tapi dengan status error
                                swal("Gagal", r.message ||
                                    "Gagal menyelesaikan sesi.", "error");
                            }
                        },
                        error: function(xhr) {
                    ...
                    $.ajax({
                        ...
                        success: function(r) {
                            if (r.status == '200') {
                                ...
                                tracking_table.draw();
                                history_table.draw();
                                toast('Berhasil', 'Data berhasil dicancel',
                                    'success');
                            }
                        }
                    });
                    ...
                    $.ajax({
                        ...
                        success: function(r) {
                            if (r.status == '200') {
                                ...
                                swal('Invoice Terhubung',
                                    'Invoice ini sudah pernah di refund / exchange, jika ingin membatalkan silahkan batalkan invoice baru dari invoice ini, yaitu ' +
                                    r.invoice, 'warning');
                            }
                        }
                    });
