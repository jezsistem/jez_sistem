    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                ...
                @else
                    <div class="symbol-label"
                        style="background-image:url('{{ $data['user']->u_photo ? Storage::disk('s3')->url($data['user']->u_photo) : asset('photos/no_image.png') }}');">
                    </div>
                @endif
        ...
        <div class="navi navi-spacer-x-0 p-0">
            ...
            <a href="#" class="navi-item">
                <div class="navi-link">
                    ...
                    <div class="navi-text">
                        ...
                        <div class="text-muted">{{ optional(auth()->user()->remainingLeaveBalance)->lb_remaining_balance ?? 0 }} hari</div>
                    </div>
                </div>
            </a>
            ...
            <a href="{{ route('break-times.index') }}" class="navi-item">
                <div class="navi-link">
                    <i class="ki-outline ki-coffee bg-icon-sm fs-2 mr-2"></i>
                    <div class="navi-text">
                        <div class="font-weight-bold">Break Times</div>
                    </div>
                </div>
            </a>
            <!--end:Item-->
            ...
            <form id="f_password">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-dark font-weight-bold"
                        id="change_password_btn">Ganti</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h5 class="modal-title text-dark" id="exampleModalLabel">[Reminder] Besok system akan shutdown
                    otomatis
                                ...
                                <div class="card shadow-sm mb-3">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="foto_ktp" class="form-control mt-2"
                                                accept="image/*">
                                        </div>
                                        <div class="form-group">
                                            <label>NPWP</label>
                                            <input type="text" name="npwp" class="form-control">
                                            <input type="file" name="foto_npwp" class="form-control mt-2"
                                                accept="image/*">
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="card shadow-sm mb-3">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="foto_staf" class="form-control"
                                                accept="image/*">
                                        </div>
                                        <div class="form-group">
