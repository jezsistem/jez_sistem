    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <a style="margin-bottom:10px;" class="btn btn-sm btn-light-primary font-weight-bolder float-right mr-2"
                    id="ImportModalBtn" aria-haspopup="true" aria-expanded="false">Import Data</a>
                <a style="margin-bottom:10px;" class="btn btn-sm btn-primary float-right mr-2"
...
<!-- Modal-->
<div class="modal fade" id="SubSubTargetModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-dark font-weight-bold"
                    id="save_target_detail_btn">Simpan</button>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="modal-body">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <a href="{{ asset('upload/template/set_target_template.csv') }}"
