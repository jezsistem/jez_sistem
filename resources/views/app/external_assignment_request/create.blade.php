        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form id="externalAssignmentForm">
                                @csrf
                                <!-- input main form -->
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                   ...
                                                   value="{{ old('ear_cash_advance') }}" placeholder="0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="ear_date_start">Start Date <span
                                                        class="text-danger">*</span></label>
                                            <input type="date"
                                                   class="form-control @error('ear_date_start') is-invalid @enderror"
                                                   id="ear_date_start" name="ear_date_start"
                                                   value="{{ old('ear_date_start') }}" required>
                                            @error('ear_date_start')
                                            <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>

{{--                                        <div class="form-group">--}}
{{--                                            <label for="ear_time_start">Start Time</label>--}}
{{--                                            <input type="time"--}}
{{--                                                   class="form-control @error('ear_time_start') is-invalid @enderror"--}}
{{--                                                   id="ear_time_start" name="ear_time_start"--}}
{{--                                                   value="{{ old('ear_time_start') }}">--}}
{{--                                            @error('ear_time_start')--}}
{{--                                            <div class="invalid-feedback">{{ $message }}</div> @enderror--}}
{{--                                        </div>--}}
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date"
                                                   ...
                                                   value="{{ old('ear_date_end') }}">
                                            @error('ear_date_end')
                                            <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>

{{--                                        <div class="form-group">--}}
{{--                                            <label for="ear_time_end">End Time</label>--}}
{{--                                            <input type="time"--}}
{{--                                                   class="form-control @error('ear_time_end') is-invalid @enderror"--}}
{{--                                                   id="ear_time_end" name="ear_time_end"--}}
{{--                                                   value="{{ old('ear_time_end') }}">--}}
{{--                                            @error('ear_time_end')--}}
{{--                                            <div class="invalid-feedback">{{ $message }}</div> @enderror--}}
{{--                                        </div>--}}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('ear_locations') is-invalid @enderror"
                                           id="ear_locations" name="ear_locations" value="{{ old('ear_locations') }}"
                                           required>
                                    @error('ear_locations')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="ear_note" id="ear_note"
                                              ...
                                              rows="3"
                                              placeholder="Tuliskan catatan atau deskripsi kegiatan...">{{ old('ear_note') }}</textarea>
                                    @error('ear_note')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <table class="table table-bordered" id="detailsTable">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td><input type="text" name="details[0][activity]" class="form-control"
                                                   required></td>
                                        ...
                                        <td><textarea name="details[0][description]" class="form-control"
                                                      rows="1"></textarea></td>
                                        <td>
                                            <button type="button" class="btn btn-danger btn-sm btn-remove-row">&times;
                                            </button>
                                        </td>
                                    </tr>
                                    </tbody>
