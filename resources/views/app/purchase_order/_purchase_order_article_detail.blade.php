                ...
                @foreach ($data['product'] as $row)
                    <tr>
                        ...
                        <td style="white-space: nowrap;">
                            [{{ $row->br_name }}] {{ $row->article_id }} - {{ $row->p_name }}<br />{{ $row->p_color }}
                            <img onclick="return deletePoa( {{ $row->poa_id }}, {{ $row->po_id }} )"
                                src="{{ asset('cdn/details_close.png') }}" /><br />
                            <input style="width:155px;" type="month" name="poa_reminder"
                        ...
                        <td style="white-space: nowrap;">
                            ...
                            <input type="text" class="bg-primary text-white" style="width:50px;" value="Order"
                                readonly />
                            <input type="text" class="bg-primary text-white" style="width:80px;" value="InStock"
                                readonly />
                                ...
                                @foreach ($row->subitem as $srow)
                                    <span data-poa-{{ $row->poa_id }}>
                                        <input type="text" style="width:60px;" value="{{ $srow->sz_name }}"
                                            readonly />
                                        <input type="text" id="poad_qty_{{ $row->poa_id }}_{{ $i }}"
