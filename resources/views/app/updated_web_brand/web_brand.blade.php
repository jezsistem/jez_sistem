...
<div class="mb-6">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Kelola brand website</p>
        </div>
        <div>
            <button id="add_brand_btn" class="px-4 py-2 text-sm font-medium text-white bg-gray-800 rounded-lg hover:bg-gray-900">
        ...
        <table id="Brandtb" class="w-full text-sm text-left text-gray-500">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                <tr>
                    ...
                    <th scope="col" class="px-3 py-3">Nama Brand</th>
                    <th scope="col" class="px-3 py-3">Slug</th>
                    <th scope="col" class="px-3 py-3">Deskripsi</th>
                    <th scope="col" class="px-3 py-3">Lokal</th>
                </tr>
            </thead>
...
@push('scripts')
    ...
    @include('app.updated_web_brand.web_brand_js_v2')
@endpush

@include('app.updated_web_brand.web_brand_modal_v2')
@endsection
