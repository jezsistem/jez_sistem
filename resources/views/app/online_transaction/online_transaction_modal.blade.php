...
<div class="modal fade" id="InputResiModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title text-dark" id="InputResiModalLabel">Input Single Modal</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
            <form id="f_input_single_resi">
                @csrf
                <div class="modal-body">
                    <div class="form-group mb-3">
                        <input type="hidden" name="input_single_resi_to_id" id="input_single_resi_to_id"
                            value="">
