<!-- Modal-->
<div class="modal fade" id="TopdealsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            <form id="f_topdeals">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger font-weight-bold" id="delete_topdeals_btn"
...
<!-- Modal-->
<div class="modal fade" id="ArticleListModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
            ...
            <div class="modal-body">
                <div class="card-body table-responsive">
                    <input type="search" class="form-control  col-6" id="article_list_search"
                        placeholder="Cari article" /><br />
