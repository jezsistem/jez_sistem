...
<div class="modal fade" id="ProductDiscountImportModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">

            <!-- HEADER -->
            <div class="modal-header">
                <h5 class="modal-title">Product Discount Mass Import</h5>
            ...
            <form id="f_mass_import">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Pilih template yang sudah di download dan diisi
                            <span class="text-danger">*</span></label>
                        <input type="file" class="form-control" name="mpd_template" id="mpd_template" required/>
                    </div>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light-primary font-weight-bold" data-dismiss="modal">Tutup</button>
                    <button type="submit" class="btn btn-dark font-weight-bold" id="mass_import_data_btn">Import</button>
                </div>
            </form>
