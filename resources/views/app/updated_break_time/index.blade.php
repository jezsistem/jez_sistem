...
<div class="mb-6">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('break-times.report_v2') }}" class="px-4 py-2 text-sm font-medium text-blue-700 bg-blue-100 rounded-lg hover:bg-blue-200">
                <i class="fas fa-chart-bar mr-2"></i>View Report
            </a>
            <a href="{{ route('break-times.summary-report_v2') }}" class="px-4 py-2 text-sm font-medium text-indigo-700 bg-indigo-100 rounded-lg hover:bg-indigo-200">
...
@push('scripts')
    ...
    @include('app.updated_break_time.break_time_js')
@endpush
@endsection
