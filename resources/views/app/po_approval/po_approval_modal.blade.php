        ...
        <div class="modal-content">
            <div class="modal-header bg-light">
                ...
                <div class="d-flex justify-content-center align-items-center">
                    <a type="button" class="btn btn-light-primary font-weight-bolder mr-8 " id="ExportApprovalBtn">
...
<div class="modal fade" id="FileDeliveryNoteModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-light-primary font-weight-bold" id="close_btn"
                    data-dismiss="modal">Tutup
                </button>
            </div>
        </div>
