            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-4 mt-4 d-flex flex-column">
                        <label class="badge badge-primary">Bukti Gambar Invoice dan Paket</label>
                            <div class="row  justify-content-between">
                                ...
                                <a class="input-group col-5" type="button" id="SuratJalanBtn" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="mt-2">
                                    <a class="input-group col-5" type="button" id="SuratJalanImageBtn" aria-haspopup="true" aria-expanded="false">
                                        <label class="input-group-text" for="suratJalan">
                                        <span class="svg-icon svg-icon-md">
                                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/PenAndRuller.svg-->
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    <div class="col-4">
                        ...
                        <input type="number" id="shipping_cost" class="form-control" name="shipping_cost"  onchange="updateCogs()" required/>
                    </div>
                </div>
                <!--end::Row-->
                <!--begin::Row-->
...
<!-- Modal-->
<div class="modal fade" id="SuratJalanImageModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
...
{{--                                        <input type="hidden" name="image" class="image-tag">--}}
                                        <input type="hidden" name="deliveryOrderImage" id="image-tag" class="image-tag">
                                    </div>
                                    <div class="col-md-6">
...
{{--                                        <button class="btn btn-success">Submit</button>--}}
                                        <button type="submit" class="btn btn-dark font-weight-bold" id="take_photo_btn">Submit</button>
                                    </div>
                                </div>
                        </div>
                    </div>
