            ...
            <div class="modal-header bg-light">
                ...
                <div class="mr-2">
                    <div class="dropdown dropdown-inline mr-2">
                        <a type="button" class="btn btn-primary font-weight-bolder" id="ExportBtn" aria-haspopup="true"
                            aria-expanded="false">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 mt-4">
                            ...
                            <input type="date" id="arrived_at" class="form-control" value=""
                                max="{{ date('Y-m-d') }}" />
                        </div>
                        ...
                        <div class="col-4 mt-4 d-flex flex-column">
                            <label class="badge badge-primary">Bukti Gambar Invoice dan Keterangan Dispute</label>
                            <div class="row  justify-content-between">
                                ...
                                <a class="input-group col-5 mt-2" type="button" id="UploadDisputeFile"
                                    aria-haspopup="true" aria-expanded="false">
                                    <label class="input-group-text" for="uploaddisputefile">
                                        <span class="svg-icon svg-icon-md">
                                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/PenAndRuller.svg-->
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
...
<!-- Modal-->
<form id="f_upload_suratjalan_file" enctype="multipart/form-data">
    @csrf
    <div class="modal fade" id="UploadFileSuratJalanModal" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-light">
                    <h5 class="modal-title text-dark" id="exampleModalLabel">Upload File Surat Jalan</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <i aria-hidden="true" class="ki ki-close"></i>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="card-body">
                        <div class="form-group">
                            <label>Pilih File Surat Jalan</label>
                            <span class="text-danger">*</span></label>
                            <input type="file" class="form-control" name="filedeliverynote[]" id="filedeliverynote"
                                multiple required />
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-dark font-weight-bold"
                        id="upload_file_delivery_note_btn">Upload</button>
                </div>
            </div>
        </div>
    </div>
...
<!-- Modal-->
<form id="f_upload_dispute_file" enctype="multipart/form-data">
    @csrf
    <div class="modal fade" id="UploadFileDisputeModal" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-light">
                    <h5 class="modal-title text-dark" id="exampleModalLabel">Upload File Dispute</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <i aria-hidden="true" class="ki ki-close"></i>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="card-body">
                        <div class="form-group">
                            <label>Pilih File Dispute</label>
                            <span class="text-danger">*</span></label>
                            <input type="file" class="form-control" name="filedispute[]" id="filedispute"
                                multiple required />
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light-primary font-weight-bold" id="close_import_btn"
                        data-dismiss="modal">Tutup</button>
                    <button type="submit" class="btn btn-dark font-weight-bold"
                        id="upload_file_dispute_btn">Upload</button>
                </div>
            </div>
        </div>
    </div>
...
<!-- Modal-->
<div class="modal fade" id="FileDeliveryModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title text-dark" id="exampleModalLabel">File Surat Jalan</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
            <div class="modal-body">
                <div class="card-body">
                    <div class="container">
                        <table id="FileDeliveryNoteTb" class="table table-bordered">
                            <thead>
                            <tr>
                                <th>File Dispute</th>
                                <th>Action</th>
