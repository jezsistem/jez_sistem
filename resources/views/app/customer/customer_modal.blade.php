                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Pilih template yang sudah di download dan diisi
                                <span class="text-danger">*</span></label>
                            <input type="file" class="form-control" name="cust_template" id="cust_template"
                                required />
                        </div>
                    </div>
                </div>
...
<!-- Modal-->
<div class="modal fade" id="CustomerTypeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-content">
            <form id="f_customer_type">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light-primary font-weight-bold"
                        data-dismiss="modal">Tutup</button>
                    <button type="button" class="btn btn-danger font-weight-bold" id="delete_customer_type_btn"
                        style="display:none;">Hapus</button>
                    <button type="submit" class="btn btn-dark font-weight-bold"
                        id="save_customer_type_btn">Simpan</button>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="modal-content">
            <form id="f_customer" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-1 pb-1">
                            ...
                            <input type="text" class="form-control" id="cust_store" name="cust_store"
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light-primary font-weight-bold"
                        data-dismiss="modal">Tutup</button>
                    <button type="button" class="btn btn-danger font-weight-bold" id="delete_customer_btn"
                        style="display:none;">Hapus</button>
                    <button type="submit" class="btn btn-dark font-weight-bold"
                        id="save_customer_btn">Simpan</button>
                </div>
            </form>
        </div>
    </div>
...
<!-- Modal-->
<div class="modal fade" id="CustomerCityModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true" style="overflow-y: auto;">
...
<!-- Modal-->
<div class="modal fade" id="CustomerSubdistrictModal" tabindex="-1" role="dialog"
...
<!-- Modal-->
<div class="modal fade" id="CustomerDetailModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true" style="overflow-y: auto;">
...
<!-- Modal-->
<div class="modal fade" id="SalesItemDetailModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true" style="overflow-y:auto;">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title text-dark" id="exampleModalLabel"><span id="sales_item_detail_label"></span>
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
