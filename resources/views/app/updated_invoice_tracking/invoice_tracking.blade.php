...
<div class="space-y-6 pb-12">
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 bg-white rounded-lg border border-gray-200 p-4">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Tracking invoice dan pengiriman</p>
        </div>
    ...
    <!-- Invoice Tracking Table Section -->
    <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
        <div class="p-4 border-b border-gray-200 bg-gray-50">
            <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <h3 class="text-lg font-semibold text-gray-900">Daftar Invoice Tracking</h3>
                <div class="flex flex-wrap gap-2">
                    ...
                    <button type="button" id="check_invoice_btn" class="px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-colors">
                        <i class="fas fa-search mr-2"></i>Check Invoice Baru Refund
                    </button>
                </div>
            </div>
        </div>
        <div class="p-5">
            ...
            <div class="mb-4">
                <div class="relative">
                    ...
                    <input type="search" id="invoice_tracking_search" class="block w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Cari invoice / nomor resi / customer (ketik minimal 4 karakter)">
                </div>
            </div>

            <!-- Data Table -->
            <div class="datatable-container overflow-x-auto border border-gray-200 rounded-lg">
                <table class="min-w-full divide-y divide-gray-200" id="InvoiceTrackingtb">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Resi</th>
...
@include('app.updated_invoice_tracking.invoice_tracking_modal')
@endsection

@push('styles')
@include('app.updated_invoice_tracking.invoice_tracking_css')
@endpush

@push('scripts')
<script src="https://cdn.jsdelivr.net/npm/simple-datatables@latest"></script>
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
@include('app.updated_invoice_tracking.invoice_tracking_js')
@endpush
