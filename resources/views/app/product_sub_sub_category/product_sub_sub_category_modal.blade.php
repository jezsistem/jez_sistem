...
<!-- Modal-->
<div class="modal fade" id="ProductSubSubCategoryModal" tabindex="-1" role="dialog"
            ...
            <form id="f_product_sub_sub_category">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger font-weight-bold"
                        id="delete_product_sub_sub_category_btn" style="display:none;">Hapus</button>
                    <button type="submit" class="btn btn-dark font-weight-bold"
                        id="save_product_sub_sub_category_btn">Simpan</button>
                </div>
            </form>
        </div>
    </div>
