...
<!-- Modal -->
<div class="modal fade text-left" id="shiftDetailModal" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel13" style="display: none;" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
...
<!-- Modal -->
<div class="modal fade text-left" id="InputLabaShift" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel13" style="display: none;" aria-hidden="true">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-1 pb-10">
                                ...
                                <input type="number" style="border: 2px solid #000;" class="form-control"
                                    id="laba_shift" placeholder="Rp. ......." name="laba_shift"
                                    autocomplete="off" />
                            </div>
                        </div>
                    </div>
