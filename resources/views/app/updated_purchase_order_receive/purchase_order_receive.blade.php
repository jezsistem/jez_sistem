...
<div class="space-y-6 pb-12">
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 bg-white rounded-lg border border-gray-200 p-4">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Kelola penerimaan purchase order</p>
        </div>
    ...
    <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-5">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div class="relative">
                ...
                <input type="search" id="penerimaan_search" class="block w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Cari PO/Invoice/Supplier">
            </div>
            <div>
            ...
            <div>
                ...
                <select id="po_status_filter" class="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    <option value="">- Status -</option>
                    <option value="full">Fullfilled</option>
                    <option value="unfull">Unfullfilled</option>
                </select>
            </div>
            <div>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Upload Surat Jalan</label>
                <select id="filter_delivery_note" class="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
    ...
    <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-5">
        <div class="datatable-container overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200" id="Penerimaantb">
...
@push('styles')
@include('app.updated_purchase_order_receive.purchase_order_receive_css')
@endpush

@push('scripts')
@include('app.updated_purchase_order_receive.purchase_order_receive_js')
@endpush

@include('app.updated_purchase_order_receive.purchase_order_receive_modal')
@endsection
