                ...
                <div class="col-lg-12 col-xxl-12">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-header flex-wrap py-3">
                            <div class="card-toolbar d-flex justify-content-between w-100">
                                <div class="d-flex align-items-center">
                                    <input type="search" class="form-control" style="width: 300px;" id="user_position_search" placeholder="Search"/>
                                </div>
                                <div class="d-flex align-items-center">
                                    <!--begin::Button-->
                                    <a href="{{ route('user-positions.create') }}" class="btn btn-dark font-weight-bolder" id="add_user_position_btn">
                        ...
                        <div class="card-body table-responsive">
                            <!--begin: Datatable-->
                            <table class="table table-hover table-checkable" id="userPositionTable">
...
@include('app.user_position.user_position_js') 