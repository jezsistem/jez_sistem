                        ...
                        <div class="card card-custom gutter-b">
                            <div class="card-body table-responsive">
                                ...
                                <div class="row col-12">
                                    <input type="search" class="form-control col-5" id="article_search"
                                        placeholder="Cari artikel / brand / warna" />

                                    <input type="text" class="form-control col-3 ml-2" id="total_start_article"
                                        readonly />
                                </div>
                                ...
                                <div class="row col-12 mt-2">
                                    <div class="col-3">
                                        <a type="button" class="btn btn-light-primary font-weight-bolder"
                                            id="ImportModalBtn" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <div class="col-3">
                                        <a type="button" class="btn btn-light-primary font-weight-bolder" id="CancelBtn"
                                ...
                                <a class="btn btn-sm btn-success" style="float:right; font-weight:bold;"
                                    id="mutation_btn">Mutasi</a>
                            </div>
                        </div>
                        <!--end::Card-->
                    </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card card-custom gutter-b">
                            <div class="card-body table-responsive">
                                ...
                                <!--end: Datatable-->
                                <div class="row col-12">
                                    <input type="search" class="form-control  col-6" id="article_end_search"
                                        placeholder="Cari artikel / brand / warna" />
                                    <input type="text" class="form-control form-control-sm col-3 ml-auto"
                                        id="total_end_article" readonly />
                                </div>
