                ...
                <div class="col-lg-12 col-xxl-12">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="col-12 row">
                            <!--begin::Button-->
                            <select class="form-control col-sm-6 col-lg-2 bg-primary text-white" id="br_id"
                                    name="br_id">
                            ...
                            <select class="form-control col-sm-6 col-lg-2 bg-primary text-white" id="psc_id"
                                    name="psc_id">
                            ...
                            <!--end::Button-->
                            <!--begin::Button-->
                            <select class="form-control col-sm-6 col-lg-2 bg-light-success text-dark" id="std_id"
                                    name="std_id">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                ...
                                <a class="btn btn-sm btn-info" style="background:#007bff;" id="graph_btn"><i
                        ...
                        <div class="card-body table-responsive">
                            <!--begin: Datatable-->
                            <input type="search" class="form-control  col-6" id="stock_tracking_search"
                                   placeholder="Cari artikel / customer / invoice (ketik minimal 5 karakter)"/><br/>
                            {{-- export Button --}}
                            <button class="btn btn-primary" id="export_stock_tracking">Excel</button>
