...
@section('content')
                        ...
                        <div class="card-body">
                            <form id="filterForm" class="row">
                                ...
                                <div class="col-md-3 mb-3 align-self-end">
                                    <button type="button" id="apply_filter" class="btn btn-primary w-100"><i class="fa fa-search"></i>
                                        Apply</button>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="overtimeSummaryTable" class="table table-bordered table-striped w-100">
    ...
    @include('app.overtime.summary_report_js')
@endsection
