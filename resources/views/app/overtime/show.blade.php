                    ...
                    @if ($isManager && empty($detail->approved_by))
                        <div class="btn-group ms-2">
                            <button type="button" class="btn btn-success btn-sm dropdown-toggle" data-bs-toggle="dropdown"
                                id="ManagerAction" aria-expanded="false">
                        ...
                        <table class="table table-borderless mb-0">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if (!empty($staff))
                                        @foreach ($staff as $s)
                                            <span class="badge bg-success text-dark me-1 mb-1"
                                                style="font-size: 12px; padding: 6px 10px;">{{ $s }}</span>
                                        @endforeach
                                    @else
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endphp
                                    <span class="badge bg-secondary">{{ $diffHours }} jam {{ $diffMinutes }}
                                        menit</span>
                                </td>
                            </tr>
                            <tr>
            ...
            <div class="card shadow-sm border-warning mb-4">
                <div class="card-header bg-warning text-dark d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        ...
                        {{ !empty($detail->status === 'Done') ? 'View Report Overtime' : 'Input Report Overtime' }}
                    </h5>
                </div>

                <div class="card-body">
                    @if (!empty($detail->status != 'Done'))
                        {{-- =================== FORM INPUT REPORT =================== --}}
                        <form id="formReport" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                <label for="report_desc" class="form-label">Report Description</label>
                                <textarea name="report_desc" id="report_desc" class="form-control" rows="4"
                                    placeholder="Tuliskan hasil pekerjaan selama lembur...">{{ old('report_desc', $detail->report_desc) }}</textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex">
                                    ...
                                    @if (!empty($detail->report_attachment))
                                        <div class="ml-2">
                                            <a href="{{ asset('storage/' . $detail->report_attachment) }}" target="_blank"
