<script>
    ...
    function exportToExcel() {
        const url = new URL('{{ route("break-times.staff-export-excel", $data["staff"]->id) }}');
    ...
    function exportToPDF() {
        const url = new URL('{{ route("break-times.staff-export-pdf", $data["staff"]->id) }}');
    ...
    function loadStaffStats() {
        ...
        let url = '{{ route("break-times.staff-stats", $data["staff"]->id) }}?start_date=' + startDate + '&end_date=' + endDate;
        if (status) {
            url += '&status=' + status;
        }
    ...
    function initDataTable() {
        ...
        try {
            ...
            window.staffTable = $('#staffTable').DataTable({
                ...
                ajax: {
                    url: "{{ route('break-times.staff-datatables', $data['staff']->id) }}",
                    data: function (d) {
