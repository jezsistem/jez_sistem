                ...
                <div class="col-lg-12 col-xxl-12">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('break-times.update', $breakTime->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="bt_type">Jenis Break <span class="text-danger">*</span></label>
                                            <select class="form-control" id="bt_type" name="bt_type" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="{{ route('break-times.index') }}" class="btn btn-secondary">
