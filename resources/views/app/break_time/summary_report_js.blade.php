<script>
    ...
    function updateStatistics() {
        ...
        fetch('/break-times/summary-report/stats?' + new URLSearchParams({
    ...
    function updateStatsDisplay(stats) {
        ...
        const exceededBreakTime = document.getElementById('stat-exceeded-break-time');
        ...
        if (exceededBreakTime) exceededBreakTime.textContent = stats.exceeded_break_time || 0;
    ...
    function initDataTable() {
        ...
        try {
            ...
            window.summaryTable = $('#summaryTable').DataTable({
                ...
                ajax: {
                    url: "{{ route('break-times.summary-report-datatables') }}",
                    data: function (d) {
                ...
                columns: [
                    ...
                    { 
                        ...
                        render: function(data, type, row) {
                            if (type === 'display') {
                                return '<a href="/break-times/staff/' + row.user_id + '" class="text-primary font-weight-bold" style="cursor: pointer;line-height: 1.2;">' + data + '</a><br><span class="text-muted" style="line-height: 1.8;>' + (row.u_nip || '-') + '</span>';
                            }
                            return data;
                        }
                    },
