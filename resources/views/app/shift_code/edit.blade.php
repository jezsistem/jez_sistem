    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5 fs-3">Edit {{ $data['subtitle'] }}</h5>
                <!--end::Page Title-->
            </div>
            <!--end::Info-->
        </div>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('shift-codes.update', $shiftCode->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('sc_code') is-invalid @enderror" 
                                           id="sc_code" name="sc_code" value="{{ old('sc_code', $shiftCode->sc_code) }}" 
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('sc_shift_name') is-invalid @enderror" 
                                           id="sc_shift_name" name="sc_shift_name" value="{{ old('sc_shift_name', $shiftCode->sc_shift_name) }}" 
                                    ...
                                    <div class="checkbox-group border p-3 rounded bg-light" style="max-height: 200px; overflow-y: auto;">
                                        @foreach($userTypes as $userType)
                                            <div class="custom-control custom-checkbox mb-2">
                                                <input type="checkbox" 
                                                       class="custom-control-input user-type-checkbox @if($errors->has('user_type_ids')) is-invalid @endif" 
                                                       id="user_type_{{ $userType->id }}" 
                                                       name="user_type_ids[]" 
                                                       value="{{ $userType->id }}" 
                                                       {{ in_array($userType->id, old('user_type_ids', $shiftCode->userTypes->pluck('id')->toArray())) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('sc_description') is-invalid @enderror" 
                                           id="sc_description" name="sc_description" value="{{ old('sc_description', $shiftCode->sc_description) }}" 
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('sc_start_time') is-invalid @enderror" 
                                           id="sc_start_time" name="sc_start_time" 
                                           value="{{ old('sc_start_time', $shiftCode->sc_start_time ? \Carbon\Carbon::parse($shiftCode->sc_start_time)->format('H:i') : '') }}">
                                    @error('sc_start_time')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control @error('sc_end_time') is-invalid @enderror" 
                                           id="sc_end_time" name="sc_end_time" 
                                           value="{{ old('sc_end_time', $shiftCode->sc_end_time ? \Carbon\Carbon::parse($shiftCode->sc_end_time)->format('H:i') : '') }}">
                                    @error('sc_end_time')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <!-- <small class="form-text text-muted">Kosongkan jika tidak ada waktu spesifik</small> -->
