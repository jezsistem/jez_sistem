<script>
    ...
    var pickup_list_table = $('#PickupListtb').DataTable({
        ...
        ajax: {
            url: "{{ url('pickup_list_datatables_v1') }}",
            data: function(d) {
    ...
    var out_table = $('#Outtb').DataTable({
        ...
        dom: 'rt<"text-right"ip>',
        ajax: {
            url: "{{ url('product_out_datatables_v1') }}",
            data: function(d) {
    ...
    var scan_keep_table = $('#ScanInOnlinetb').DataTable({
        ...
        dom: 'rt<"text-right"ip>',
        ajax: {
            url: "{{ url('scan_product_online_datatables_v1') }}",
            data: function(d) {
    ...
    var in_table = $('#Intb').DataTable({
        ...
        dom: 'rt<"text-right"ip>',
        ajax: {
            url: "{{ url('product_in_datatables_v1') }}",
            data: function(d) {
                // d.pl_id = $('#pl_id_out').val();
    ...
    var scan_in_table = $('#ScanIntb').DataTable({
        ...
        dom: 'rt<"text-right"ip>',
        ajax: {
            url: "{{ url('scan_product_in_datatables_v1') }}",
            data: function(d) {
                d.search = $('#scan_in_search').val();
                d.st_id = $('#st_id').val();
                d.waiting = $('#waiting_filter').val();
    ...
    var scan_in_refund_table = $('#ScanInRefundtb').DataTable({
        ...
        dom: 'rt<"text-right"ip>',
        ajax: {
            url: "{{ url('scan_product_in_refund_datatables_v1') }}",
            data: function(d) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        url: "{{ url('save_in_refund_activity_v1') }}",
                        success: function(r) {
                            if (r.status == '200') {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    url: "{{ url('save_tracking_activity_v1') }}",
                    success: function(r) {
                        if (r.status == '200') {
                            reloadOrderList();
                        } else {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    url: "{{ url('cancel_tracking_activity_v1') }}",
                    success: function(r) {
                        if (r.status == '200') {
                            reloadOrderList();
                        } else {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    url: "{{ url('save_packing_activity_v1') }}",
                    success: function(r) {
                        if (r.status == '200') {
                            reloadPackingList();
                        } else {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    url: "{{ url('save_reject_activity_v1') }}",
                    success: function(r) {
                        if (r.status == '200') {
                            reloadPackingList();
                        } else {
