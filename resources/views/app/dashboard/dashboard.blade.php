        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Daterange-->
                    <a href="{{ url('dashboards') }}" class="btn btn-inventory mr-2" id="del_activity_btn">Dashboard V2</a>
                        ...
                        <div class="card card-custom card-stretch gutter-b" style="border-radius:.625rem;">
                            ...
                            <div class="card-body">
                                ...
                                <center class="button-show_ns pt-10">
                                    ...
                                    <img class="d-none" id="ns_loading" src="{{ asset('upload/loading/loading.gif') }}"
                        ...
                        <div class="card card-custom card-stretch gutter-b" style="border-radius:.625rem;">
                            ...
                            <div class="card-body">
                                ...
                                <center class="button-show_cpr pt-20">
                                    ...
                                    <img class="d-none" id="cpr_loading" src="{{ asset('upload/loading/loading.gif') }}"
                                        style="width:20%; padding-bottom:20px;" />
                                </center>
                        ...
                        <div class="card card-custom card-stretch gutter-b" style="border-radius:.625rem;">
                            ...
                            <div class="card-body">
                                ...
                                <center class="button-show_pc pt-20">
                                    ...
                                    <img class="d-none" id="pc_loading" src="{{ asset('upload/loading/loading.gif') }}"
                                        style="width:20%; padding-bottom:20px;" />
                                </center>
