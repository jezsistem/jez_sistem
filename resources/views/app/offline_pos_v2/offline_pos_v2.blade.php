...
<body>
                        ...
                        <div id="calculatorDropdown" class="hidden absolute right-0 mt-2 z-50 bg-white rounded-lg shadow-xl w-72 p-4 border border-gray-200">
                            <div class="calculator-container">
                                ...
                                <div class="grid grid-cols-4 gap-2">
                                    <!-- Operators Row -->
                                    <button class="calc-btn calc-operator bg-red-100 hover:bg-red-200 text-red-700 font-semibold pt-0.5 pb-1 rounded" data-value="+">+</button>
                                    <button class="calc-btn calc-operator bg-red-100 hover:bg-red-200 text-red-700 font-semibold pt-0.5 pb-1 rounded" data-value="-">-</button>
                                    <button class="calc-btn calc-operator bg-red-100 hover:bg-red-200 text-red-700 font-semibold pt-0.5 pb-1 rounded" data-value="×">×</button>
                                    <button class="calc-btn calc-operator bg-red-100 hover:bg-red-200 text-red-700 font-semibold pt-0.5 pb-1 rounded" data-value="÷">÷</button>
                                    <!-- Numbers -->
                                    <button class="calc-btn calc-number bg-gray-100 hover:bg-gray-200 text-gray-800 font-semibold pt-0.5 pb-1 rounded" data-value="7">7</button>
                                    <button class="calc-btn calc-number bg-gray-100 hover:bg-gray-200 text-gray-800 font-semibold pt-0.5 pb-1 rounded" data-value="8">8</button>
                                    <button class="calc-btn calc-number bg-gray-100 hover:bg-gray-200 text-gray-800 font-semibold pt-0.5 pb-1 rounded" data-value="9">9</button>
                                    <button class="calc-btn calc-number bg-gray-100 hover:bg-gray-200 text-gray-800 font-semibold pt-0.5 pb-1 rounded" data-value="4">4</button>
                                    <button class="calc-btn calc-number bg-gray-100 hover:bg-gray-200 text-gray-800 font-semibold pt-0.5 pb-1 rounded" data-value="5">5</button>
                                    <button class="calc-btn calc-number bg-gray-100 hover:bg-gray-200 text-gray-800 font-semibold pt-0.5 pb-1 rounded" data-value="6">6</button>
                                    <button class="calc-btn calc-number bg-gray-100 hover:bg-gray-200 text-gray-800 font-semibold pt-0.5 pb-1 rounded" data-value="1">1</button>
                                    <button class="calc-btn calc-number bg-gray-100 hover:bg-gray-200 text-gray-800 font-semibold pt-0.5 pb-1 rounded" data-value="2">2</button>
                                    <button class="calc-btn calc-number bg-gray-100 hover:bg-gray-200 text-gray-800 font-semibold pt-0.5 pb-1 rounded" data-value="3">3</button>
                                    <button class="calc-btn calc-number bg-gray-100 hover:bg-gray-200 text-gray-800 font-semibold pt-0.5 pb-1 rounded" data-value="0">0</button>
                                    <button class="calc-btn calc-number bg-gray-100 hover:bg-gray-200 text-gray-800 font-semibold pt-0.5 pb-1 rounded" data-value=".">.</button>
                                    <button class="calc-btn calc-clear bg-red-500 hover:bg-red-600 text-white font-semibold pt-0.5 pb-1 rounded" data-value="C">C</button>
                                    <button class="calc-btn calc-equals bg-red-500 hover:bg-red-600 text-white font-semibold pt-0.5 pb-1 rounded col-span-2" data-value="=">=</button>
                                </div>
                                <div class="mt-3">
                                    <button class="w-full px-4 py-2 bg-red-500 hover:bg-red-600 text-white rounded-lg font-medium transition-colors" id="add_custom_amount">
                                        Add Custom Amount
                                    </button>
                                </div>
                            </div>
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <form id="f_customer" class="p-4 md:p-5 space-y-4 max-h-[calc(100vh-200px)] overflow-y-auto">
                    ...
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
                        <input type="text" id="cust_email" name="cust_email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Email">
                    </div>
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Provinsi</label>
                        <select id="cust_province" name="cust_province" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            <option value="">- Pilih -</option>
                    ...
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kota</label>
                        <select id="cust_city" name="cust_city" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            <option value="">- Pilih -</option>
                        </select>
                    </div>
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kecamatan</label>
                        <select id="cust_subdistrict" name="cust_subdistrict" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            <option value="">- Pilih -</option>
                        </select>
                    </div>
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Alamat</label>
                        <input type="text" id="cust_address" name="cust_address" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Alamat">
                    </div>
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Status Customer</label>
                        <select id="cust_token_active" name="cust_token_active" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
        ...
        <div class="relative p-4 w-full max-w-4xl max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="payment-offline-popup" id="close-payment-modal" aria-label="Close modal">
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                        </svg>
                        <span class="sr-only">Close modal</span>
                ...
                <div class="p-4 md:p-5 space-y-4 max-h-[calc(100vh-200px)] overflow-y-auto">
                    ...
                    <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-2xl font-bold text-red-600" id="payment_total">Rp. 0</span>
                        </div>
                    </div>

                    <!-- Down Payment -->
                    <div class="flex items-center gap-2">
                        <input type="checkbox" id="dp_checkbox" value="dp" class="w-4 h-4 text-red-600 bg-gray-100 border-gray-300 rounded focus:ring-red-500">
                        <label for="dp_checkbox" class="text-sm font-medium text-gray-900 dark:text-white">Down Payment</label>
                    </div>

                    <!-- Metode Pembayaran -->
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Metode Pembayaran</label>
                        <select id="payment_option" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            <option value="">- Pilih -</option>
                    ...
                    <!-- Payment Method 1 -->
                    <div id="payment_type_content" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jenis Pembayaran (1)</label>
                            <select id="pm_id_offline" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                <option value="">- Pilih -</option>
                        ...
                        <div id="sub_payment_offline_content" class="hidden">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Sub Pembayaran</label>
                            <select id="sub_payment_offline" name="sub_payment_offline" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                <option value="">- Pilih -</option>
                                <option value="3">On Us</option>
                                <option value="4">Off Us</option>
                            </select>
                        </div>
                        <div id="card_provider_content" class="hidden">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mesin EDC</label>
                        ...
                        <div id="card_number_label" class="hidden">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">No. Kartu</label>
                            <input type="text" id="card_number" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="">
                        </div>
                        <div id="ref_number_label" class="hidden">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Rekening Pengirim</label>
                            <input type="text" id="ref_number" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="">
                        </div>
                        <div id="charge_label" class="hidden">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Charge (%)</label>
                            <div class="grid grid-cols-2 gap-2">
                                <input type="number" id="charge" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="">
                                <input type="number" id="charge_total" readonly class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            </div>
                        </div>
                    </div>

                    <!-- Payment Method 2 -->
                    <div id="payment_type_content_two" class="grid grid-cols-1 md:grid-cols-2 gap-4 hidden">
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jenis Pembayaran (2)</label>
                            <select id="pm_id_offline_two" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                <option value="">- Pilih -</option>
                                @foreach ($data['payment_method'] as $key => $value)
                                    <option value="{{ $key }}">{{ $value }}</option>
                                @endforeach
                        ...
                        <div id="card_provider_content_two" class="hidden">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mesin EDC</label>
                            <select id="cp_id_two" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                <option value="">- Pilih -</option>
                                @foreach ($data['cp_id'] as $key => $value)
                                    <option value="{{ $key }}">{{ $value }}</option>
                                @endforeach
                        ...
                        <div id="card_number_label_two" class="hidden">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">No. Kartu</label>
                            <input type="text" id="card_number_two" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="">
                        </div>
                        <div id="ref_number_label_two" class="hidden">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Rekening Pengirim</label>
                            <input type="text" id="ref_number_two" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="">
                        </div>
                    </div>

                    <!-- Online Mode Fields -->
                    <div id="online_mode" class="grid grid-cols-1 md:grid-cols-2 gap-4 hidden">
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kode Unik</label>
                            <input type="text" id="unique_code" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="(isi jika online)">
                        </div>
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Charge Lain-Lain (+)</label>
                            <input type="text" id="another_cost" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="(isi jika online)">
                        </div>
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Biaya Admin (-)</label>
                            <input type="text" id="admin_cost" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="(isi jika online)">
                        </div>
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kurir</label>
                            <select name="cr_id" id="cr_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ongkos Kirim (isi jika online)</label>
                            <input type="number" id="shipping_cost" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Ongkos Kirim">
                        </div>
                    </div>

                    <!-- Total Payment -->
                    <div id="total_payment_label" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jumlah yang dibayar Customer</label>
                            <input type="text" name="number" id="total_payment" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" value="" placeholder="Jumlah">
                        </div>
                        <div id="total_payment_two_label" class="hidden">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jumlah yang dibayar Customer</label>
                            <input type="text" name="number" id="total_payment_two" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" value="" placeholder="Jumlah">
                        </div>
                    </div>

                    <!-- Return Payment -->
                    <div id="return_payment_label" class="bg-red-50 border border-red-200 rounded-lg p-4 hidden">
                        <div class="flex justify-between items-center">
                            <h5 class="text-sm font-semibold text-red-700">Kembalian</h5>
                            <h5 class="text-lg font-bold text-red-600"><span id="return_payment">Rp. 0</span></h5>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-end gap-2 pt-4 border-t border-gray-200 dark:border-gray-600">
                        <button type="button" data-modal-hide="payment-offline-popup" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 border border-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:text-white">Batal</button>
                        <button type="button" id="checkout_btn" class="text-white bg-red-600 hover:bg-red-500  focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-500  dark:focus:ring-red-800">Checkout</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- PAYMENT MODAL HANDLER - Set total bayar when modal opens -->
    <script>
        console.log('💳 Payment modal handler script loaded');
        
        // Simple helper functions for number formatting (Indonesian format with . separator)
        function replaceComma(val) {
            // Remove both . and , then convert to number
        ...
        function addCommas(num) {
            ...
            // Format with . as thousands separator (Indonesian format)
            return intNum.toString().replace(/\B(?=(\d{3})+(?!\d))/g, '.');
        }
        
        // Handle payment modal opening
        document.addEventListener('DOMContentLoaded', function() {
            console.log('💳 Setting up payment modal handler...');
            ...
            const paymentTypeContent = document.getElementById('payment_type_content');
            const paymentTypeContentTwo = document.getElementById('payment_type_content_two');
            const totalPaymentLabel = document.getElementById('total_payment_label');
            const totalPaymentTwoLabel = document.getElementById('total_payment_two_label');
            ...
            console.log('✅ Payment button found, attaching click handler');
            
            paymentBtn.addEventListener('click', function(e) {
                console.log('💳 Payment button clicked!');
                
                if (totalFinalPrice && paymentTotal) {
                    const totalText = totalFinalPrice.textContent || '0';
                    console.log('💰 Total from total_final_price_side:', totalText);
                    
                    // Remove 'Rp. ' prefix and commas
                    const cleanTotal = String(totalText).replace('Rp. ', '').trim();
                    const numericTotal = replaceComma(cleanTotal);
                    
                    console.log('💰 Cleaned total:', numericTotal);
                    ...
                    console.warn('⚠️ Total elements not found');
                }
            });
            
            // Handle Metode Pembayaran (1 Metode vs 2 Metode) selection
            if (paymentOption) {
                paymentOption.addEventListener('change', function(e) {
                    ...
                    if (selected === 'two') {
                        console.log('📊 Showing 2 Metode payment');
                        // Show payment method 2
                        if (paymentTypeContentTwo) paymentTypeContentTwo.classList.remove('hidden');
                        if (totalPaymentTwoLabel) totalPaymentTwoLabel.classList.remove('hidden');
                        if (returnPaymentLabel) returnPaymentLabel.classList.add('hidden');
                    } else {
                        console.log('📊 Showing 1 Metode payment');
                        // Hide payment method 2, show return payment
                        if (paymentTypeContentTwo) paymentTypeContentTwo.classList.add('hidden');
                        if (totalPaymentTwoLabel) totalPaymentTwoLabel.classList.add('hidden');
                        if (returnPaymentLabel) returnPaymentLabel.classList.remove('hidden');
                    }
                });
            }
            
            // Handle payment method (Jenis Pembayaran) selection for first payment method
            if (pmIdOffline) {
                pmIdOffline.addEventListener('change', function(e) {
                    const selectedText = this.options[this.selectedIndex].text;
                    console.log('💳 Payment method 1 changed to:', selectedText);
                    hidePaymentFields();
                    showFieldsForPaymentMethod(selectedText, '');
                });
            }
            
            // Handle payment method selection for second payment method
            if (pmIdOfflineTwo) {
                pmIdOfflineTwo.addEventListener('change', function(e) {
                    const selectedText = this.options[this.selectedIndex].text;
                    console.log('💳 Payment method 2 changed to:', selectedText);
                    hidePaymentFieldsTwo();
                    showFieldsForPaymentMethod(selectedText, '_two');
                });
            }
            
            // Helper function to hide all payment fields
            function hidePaymentFields() {
                const fieldIds = [
                    'sub_payment_offline_content',
                    'card_provider_content',
                    'card_number_label',
                    'ref_number_label',
                    'charge_label'
                ];
            ...
            // Helper function to hide all payment fields for second method
            function hidePaymentFieldsTwo() {
                const fieldIds = [
                    'card_provider_content_two',
                    'card_number_label_two',
                    'ref_number_label_two'
                ];
                fieldIds.forEach(id => {
                    const el = document.getElementById(id);
                    if (el) el.classList.add('hidden');
            ...
            // Helper function to show appropriate fields based on payment method
            function showFieldsForPaymentMethod(methodLabel, suffix) {
                if (methodLabel.includes('DEBIT')) {
                    console.log('🏦 Showing DEBIT CARD fields');
                    showElement('card_provider_content' + suffix);
                    showElement('card_number_label' + suffix);
                    showElement('ref_number_label' + suffix);
                } else if (methodLabel.includes('CREDIT')) {
                    console.log('🏦 Showing CREDIT CARD fields');
                    showElement('card_provider_content' + suffix);
                    showElement('card_number_label' + suffix);
                    showElement('ref_number_label' + suffix);
                    showElement('charge_label' + suffix);
                } else if (methodLabel.includes('CASH')) {
                    console.log('💵 CASH payment - hiding all special fields');
                    // Don't show any special fields for cash
                } else if (methodLabel.includes('EDC')) {
                    console.log('🖥️ EDC payment - showing EDC fields');
                    if (!suffix) { // Only for first payment method
                        showElement('sub_payment_offline_content');
                    }
                } else {
                    console.log('💰 Other payment method - showing reference fields');
                    showElement('ref_number_label' + suffix);
                }
            }
            ...
            console.log('✅ Payment modal handler setup complete');
        });
    </script>
    ...
    <script>
        ...
        window.updateProductTable = function() {
            ...
            window.orderItems.forEach((item, index) => {
                ...
                const stock = isWaiting ? 1 : (item.pls_qty || 0); // WAITING always shows 1, STORE/B1G1 shows actual stock
                ...
                row = `
                    <tr data-list-item data-product-id="${item.id || ''}" data-pl-id="${item.pl_id || ''}" data-plst-id="${item.plst_id || ''}" class="${returClass} transition-colors pos_item_list ${b1g1Class}" id="orderList${item.index || index}">
                        ...
                        <td class="px-4 py-3 text-center">
                            <input type="number" id="discount_percentage${item.index || index}" class="w-16 px-2 py-1.5 ${inputBgClass} border border-gray-300 ${textClass} text-xs rounded-lg focus:ring-red-400 focus:border-red-400 text-center" value="${discPercent}" placeholder="%" min="0" step="0.01" onchange="if(typeof changeDiscountPercentage === 'function') changeDiscountPercentage(${item.index || index}, ${item.id || ''}, ${stock})" ${isRetur ? 'disabled' : ''}>
                        </td>
                        <td class="px-4 py-3">
                            <input type="number" id="discount_number${item.index || index}" class="w-24 px-2 py-1.5 ${inputBgClass} border border-gray-300 ${textClass} text-xs rounded-lg focus:ring-red-400 focus:border-red-400" value="${discRp}" placeholder="Rp" min="0" onchange="if(typeof changeDiscountNumber === 'function') changeDiscountNumber(${item.index || index}, ${item.id || ''}, ${stock})" ${isRetur ? 'disabled' : ''}>
                        </td>
                        <td class="px-4 py-3 text-center">
                        ...
                        <td class="px-4 py-3 text-center">
                            <button type="button" onclick="if(typeof deleteItem === 'function') deleteItem(${item.id || ''}, ${price}, ${item.index || index}, ${item.pl_id || ''}, ${item.plst_id || ''}, ${bandrol})" class="w-8 h-8 flex items-center bg-red-50 justify-center text-red-500 hover:text-red-800 hover:bg-red-100 rounded transition-colors" title="Hapus">
        ...
        $(document).ready(function() {
            ...
            jQuery(document).on('click', '#add_to_item_list', function(e) {
                ...
                if (product) {
                    ...
                    if (existingIndex >= 0) {
                        // Stock guard when incrementing existing item
                        ...
                        if ((existingQty + 1) > availableStock) {
                            if (typeof showToast === 'function') {
                                    showToast('Melebihi Stok<br>Jumlah item tidak boleh melebihi stok yang tersedia', 'warning');
                                } else if (typeof swal !== 'undefined') {
                                    swal('Melebihi Stok', 'Jumlah item tidak boleh melebihi stok yang tersedia', 'warning');
                                }
                            console.log('⚠️ Attempt to increase qty beyond stock blocked');
                        } else {
                            window.orderItems[existingIndex].quantity += 1;
                            console.log('✅ Updated existing item quantity');
                        }
                    } else {
                        // Stock guard when adding new item
                        const availableStockNew = parseInt(item.pls_qty || 0) || 0;
                        if (availableStockNew <= 0) {
                            if (typeof showToast === 'function') {
                                    showToast('Stok Habis<br>Produk ini tidak memiliki stok yang dapat ditambahkan', 'warning');
                                } else if (typeof swal !== 'undefined') {
                                    swal('Stok Habis', 'Produk ini tidak memiliki stok yang dapat ditambahkan', 'warning');
                                }
                            console.log('⚠️ Prevented adding item with zero stock');
                        } else {
                            // Set index based on current array length
    ...
    <script>
        ...
        window.changeQty = function(index, pstId, stock) {
            ...
            // Stock guard: if stock provided, prevent exceeding it
            ...
            if (availableStock !== null && !isNaN(availableStock)) {
                if (Math.abs(newQty) > availableStock) {
                    // revert input value
                    jQuery(`#item_qty${index}`).val(item.quantity || 1);
                    // show toast via showToast helper (preferred) or swal fallback
                    if (typeof showToast === 'function') {
                        showToast('Melebihi Stok<br>Jumlah item tidak boleh melebihi stok yang tersedia', 'warning');
                    } else if (typeof swal !== 'undefined') {
                        swal('Melebihi Stok', 'Jumlah item tidak boleh melebihi stok yang tersedia', 'warning');
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setTimeout(function() {
                ...
                // Fix customer modal - Ensure Flowbite initializes and shows it correctly
                $(document).on('click', '#add-customer-btn', function(e) {
                    e.preventDefault();
                    e.stopPropagation();
                    
                    const modalElement = document.getElementById('modal-customer');
                    console.log('Customer modal button clicked, modal element:', modalElement);
                    
                    if (!modalElement) {
                        console.error('Modal customer element not found!');
                        return;
                    }
                    
                    // Check if Flowbite.Modal is available (same check as pos_v2.js)
                    if (typeof Flowbite === 'undefined' || !Flowbite.Modal) {
                        console.error('Flowbite.Modal is not available!');
                    ...
                    // Get or create Flowbite modal instance
                    let flowbiteModal = Flowbite.Modal.getInstance(modalElement);
                    console.log('Flowbite modal instance:', flowbiteModal);
                    
                    if (!flowbiteModal) {
                        try {
                            console.log('Creating new Flowbite modal instance...');
                            flowbiteModal = new Flowbite.Modal(modalElement, {
                                backdrop: 'static',
                                closable: true
                            });
                            modalElement.setAttribute('data-flowbite-initialized', 'true');
                            console.log('Flowbite modal created:', flowbiteModal);
                        } catch(err) {
                    ...
                    const closeBtn = document.getElementById('close-modal-customer');
                    if (closeBtn) {
            ...
            jQuery(document).on('click', '#close-payment-modal', function(e) {
                ...
                $(document).on('click', function(e) {
                    ...
                    if (!$(e.target).closest('#product_name_input, #itemList, #barcode_input, #invoice_input, #cust_id_label, #itemListCust, #transaction-search, #transaction-list').length) {
                        $('#itemList').addClass('hidden').removeClass('block');
