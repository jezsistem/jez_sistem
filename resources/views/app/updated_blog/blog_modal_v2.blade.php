    ...
    <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white">
        ...
        <form id="f_bc">
            ...
            <div class="flex justify-end gap-2 mt-6 pt-4 border-t">
                ...
                <button type="submit" id="save_bc_btn" class="px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600">Simpan</button>
            </div>
        </form>
    </div>
</div>
    ...
    <div class="relative top-10 mx-auto p-5 border w-11/12 md:w-4/5 lg:w-3/4 shadow-lg rounded-md bg-white max-h-[90vh] overflow-y-auto">
        ...
        <form id="f_bcc" enctype="multipart/form-data">
            ...
            <div class="flex justify-end gap-2 mt-6 pt-4 border-t sticky bottom-0 bg-white">
                ...
                <button type="submit" id="save_bcc_btn" class="px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600">Simpan</button>
            </div>
        </form>
    </div>
</div>
