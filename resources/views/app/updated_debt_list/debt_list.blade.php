...
<div class="mb-6">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Kelola daftar hutang</p>
        </div>
        <div class="flex gap-2">
            <div class="relative">
                <button type="button" id="debt_list_export_btn" class="px-4 py-2 text-sm font-medium text-white bg-green-600 rounded-lg hover:bg-green-700">
...
<div class="bg-white rounded-lg shadow-md p-6">
    ...
    <div class="mb-6 flex flex-col md:flex-row gap-4">
        ...
        <div class="w-full md:w-2/3">
            ...
            <input type="search" id="debt_list_search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Cari invoice...">
        </div>
    </div>

    <!-- Table -->
    <div class="overflow-x-auto">
        <table id="DebtListtb" class="w-full text-sm text-left text-gray-500">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                <tr>
                    <th scope="col" class="px-3 py-3">No</th>
                    <th scope="col" class="px-3 py-3">Store</th>
                    <th scope="col" class="px-3 py-3">Supplier</th>
                    <th scope="col" class="px-3 py-3">Brand</th>
                    <th scope="col" class="px-3 py-3">Invoice</th>
                    <th scope="col" class="px-3 py-3">Tanggal</th>
                    <th scope="col" class="px-3 py-3">Jatuh Tempo</th>
                    <th scope="col" class="px-3 py-3">DPP</th>
                    <th scope="col" class="px-3 py-3">VAT</th>
                    <th scope="col" class="px-3 py-3">TOTAL</th>
                    <th scope="col" class="px-3 py-3">Payment Value</th>
                </tr>
            </thead>
            <tbody id="debt_list_tbody">
                <tr>
    ...
    <div class="flex justify-between items-center mt-4">
        <div id="debt_list_pagination_info" class="text-sm text-gray-600"></div>
        <div id="debt_list_pagination_controls" class="flex items-center gap-2"></div>
    </div>
</div>
...
@push('scripts')
    ...
    @include('app.updated_debt_list.debt_list_js_v2')
@endpush

@include('app.updated_debt_list.debt_list_modal_v2')
@endsection
