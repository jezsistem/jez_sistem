            ...
            <form id="f_product_supplier">
                ...
                <div class="modal-body">
                    <div class="card-body">
                        <div class="form-group mb-1 pb-1">
                            ...
                            <input type="text" class="form-control" id="ps_name" name="ps_name" autocomplete="off"
                                required />
                        </div>
                        <div class="form-group mb-1 pb-1">
                        ...
                        <div class="form-group mb-1 pb-1">
                            ...
                            <input type="number" class="form-control" id="ps_due_day" autocomplete="off"
                                name="ps_due_day" />
                        </div>
                        <div class="form-group mb-1 pb-1">
                            <label for="exampleTextarea">Email</label>
                            <input type="email" class="form-control" id="ps_email" autocomplete="off"
                                name="ps_email" />
                        </div>
                        <div class="form-group mb-1 pb-1">
                            <label for="exampleTextarea">No Telp</label>
                            <input type="text" class="form-control" id="ps_phone" autocomplete="off"
                                name="ps_phone" />
                        </div>
                        <div class="form-group mb-1 pb-1">
                            <label for="exampleTextarea">Alamat <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="ps_address" autocomplete="off"
                                name="ps_address" required />
                        </div>
                        <div class="form-group mb-1 pb-1">
                            <label for="exampleTextarea">Rekening</label>
                            <input type="text" class="form-control" id="ps_rekening" autocomplete="off"
                                name="ps_rekening" />
                        </div>
                        <div class="form-group mb-1 pb-1">
                            <label for="exampleTextarea">NPWP</label>
                            <input type="text" class="form-control" id="ps_npwp" autocomplete="off"
                                name="ps_npwp" />
                        </div>
                        <div class="form-group mb-1 pb-1">
                            <label for="exampleTextarea">Deskripsi</label>
                            <input type="text" class="form-control" id="ps_description" autocomplete="off"
                                name="ps_description" />
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-dark font-weight-bold"
                        id="save_product_supplier_btn">Simpan</button>
                </div>
            </form>
        </div>
    </div>
