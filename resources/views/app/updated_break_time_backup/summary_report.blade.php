...
<div class="mb-6">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-xl font-semibold text-gray-900">Backup Time Summary Report</h1>
...
<!-- Statistics Cards -->
<div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-6" id="stats-container">
    ...
    <div class="bg-white rounded-lg p-4 border border-gray-200 shadow-sm bg-red-50 border-red-200">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <div class="text-sm text-gray-600">Total Backup</div>
            </div>
        </div>
    </div>
    <div class="bg-white rounded-lg p-4 border border-gray-200 shadow-sm bg-gray-50 border-gray-200">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <div class="text-sm text-gray-600">No Backup</div>
            </div>
        </div>
    </div>
    <div class="bg-white rounded-lg p-4 border border-gray-200 shadow-sm bg-yellow-50 border-yellow-200">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <div class="text-sm text-gray-600">Avg Backup/Staff</div>
            </div>
        </div>
    </div>
</div>
        ...
        <table id="SummaryTable" class="w-full text-sm text-left text-gray-500">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                <tr>
                    ...
                    <th scope="col" class="px-3 py-3 text-center">Total Backup</th>
                </tr>
            </thead>
...
@push('scripts')
    ...
    @include('app.updated_break_time_backup.summary_report_js')
@endpush
@endsection
