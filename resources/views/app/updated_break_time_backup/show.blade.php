...
<div class="mb-6">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-xl font-semibold text-gray-900">Detail Backup Time</h1>
        </div>
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('break-times-backup.edit_v2', $breakTime->id) }}" class="px-4 py-2 text-sm font-medium text-yellow-700 bg-yellow-100 rounded-lg hover:bg-yellow-200">
