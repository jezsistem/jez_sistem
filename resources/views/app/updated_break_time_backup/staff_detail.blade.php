...
<div class="mb-6">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-xl font-semibold text-gray-900">Backup Time Details - {{ $data['staff']->u_name }}</h1>
        </div>
        <div class="flex items-center gap-3">
            <a href="{{ route('break-times-backup.summary-report_v2') }}" class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200">
...
@push('scripts')
    ...
    @include('app.updated_break_time_backup.staff_detail_js')
@endpush
@endsection
