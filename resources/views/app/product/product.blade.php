...
@section('content')
            ...
            <div class="card-spacer" style="padding-top: 0px;">
                ...
                <div class="row m-0">
                    ...
                    <div class="col bg-primary px-3 py-8 rounded-xl mr-7 mb-7">
                        ...
                        <a href="#" class="text-light font-weight-bold font-size-h6 mt-2">{{ $data['total_product'] }}
                            Total</a>
                    </div>
                    ...
                    <div class="col bg-primary px-3 py-8 rounded-xl mr-7 mb-7">
                        ...
                        <a href="#" class="text-light font-weight-bold font-size-h6 mt-2">{{ $data['total_apparel'] }}
                            Apparel</a>
                    </div>
                    ...
                    <div class="col bg-primary px-3 py-8 rounded-xl mr-7 mb-7">
                        ...
                        <a href="#"
                            class="text-light font-weight-bold font-size-h6 mt-2">{{ $data['total_footwear'] }} Footwear</a>
                    </div>
                    ...
                    <div class="col bg-primary px-3 py-8 rounded-xl mr-7 mb-7">
                        ...
                        <a href="#"
                            class="text-light font-weight-bold font-size-h6 mt-2">{{ $data['total_accessories'] }}
                            Accessories</a>
                    </div>
                    ...
                    <div class="col bg-primary px-3 py-8 rounded-xl mb-7">
                        ...
                        <a href="#"
                            class="text-light font-weight-bold font-size-h6 mt-2">{{ $data['total_others'] }} Others</a>
                    </div>
                            ...
                            <div class="card-header flex-wrap py-3">
                                ...
                                <div class="dropdown dropdown-inline mr-2">
                                    <button type="button" class="btn btn-light-primary font-weight-bolder"
                                        id="import_modal_btn" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <a href="#" class="btn btn-info font-weight-bolder ml-2"
                        ...
                        <div class="card card-custom gutter-b">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                            ...
                                            <ul class="navi flex-column navi-hover py-2">
                                                ...
                                                <li class="navi-item">
                                                    ...
                                                    <a href="{{ url('p_export') }}" class="navi-link">
                                                        <span class="navi-icon">
                                                            <i class="la la-copy"></i>
                                                        </span>
                            ...
                            <div class="table-responsive">
                                ...
                                <center><input type="search" class="form-control  col-6" id="product_search"
                                        placeholder="Cari nama artikel / warna / brand / supplier" /></center><br />
    ...
    <!--end::Content-->
    @include('app.product.product_modal')
    @include('app._partials.js')
    @include('app.product.product_js')
@endSection()