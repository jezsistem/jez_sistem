<script>
    ...
    function reloadSubCategory(type, id) {
        ...
        $.ajax({
            ...
            dataType: 'html',
            url: "{{ url('stock_data_reload_sub_category_v1') }}",
            success: function (r) {
                $('#psc_id').html(r);
            }
        });
    ...
    function reloadSubOnSubCategory(type, id) {
        ...
        $.ajax({
            ...
            dataType: 'html',
            url: "{{ url('stock_data_reload_sub_sub_category_v1') }}",
            success: function (r) {
                $('#pssc_id').html(r);
            }
        });
    ...
    function reloadBrand(type, id) {
        ...
        $.ajax({
            ...
            dataType: 'html',
            url: "{{ url('stock_data_reload_brand_v1') }}",
            success: function (r) {
                $('#br_id').html(r);
            }
        });
    ...
    function reloadSize(type, id) {
        ...
        $.ajax({
            ...
            dataType: 'html',
            url: "{{ url('stock_data_reload_size_v1') }}",
            success: function (r) {
                $('#sz_id').html(r);
            }
        });
    ...
    function reloadName(type, id) {
        ...
        $.ajax({
            ...
            dataType: 'html',
            url: "{{ url('stock_data_reload_product_v1') }}",
            success: function (r) {
                $('#p_name').html(r);
            }
        });
    ...
    $(document).ready(function () {
        ...
        var stock_data_table = $('#StockDatatb').DataTable({
            ...
            ajax: {
                url: "{{ url('stock_data_datatables_v1') }}",
                data: function (d) {
                ...
                swal({
                    ...
                    if (isConfirm) {
                        ...
                        $.ajax({
                            ...
                            dataType: 'json',
                            url: "{{ url('pickup_approval_item_v1') }}",
                            success: function (r) {
                                if (r.status == '200') {
                                    stock_data_table.draw();
                                    pickup_list_table.draw();
    ...
    function reloadCategory(type, id) {
        ...
        $.ajax({
            ...
            dataType: 'html',
            url: "{{ url('stock_data_reload_category_v1') }}",
            success: function (r) {
                $('#pc_id').html(r);
            }
        });
    ...
    function updateRequestCount() {
        ...
        $.ajax({
            url: '{{ url('request_count_pickup_v1') }}',
            type: "POST",
            data: {
