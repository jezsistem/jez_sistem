<script>
    ...
    $(document).ready(function() {
        ...
        $('#Banktb tbody').on('click', 'tr td:not(:nth-child(2))', function() {
            ...
            if (bank_image != null) {
                $('#imagePreview').attr('src', "{{ asset('api/bank/100') }}/" + bank_image);
            }
            $('#_id').val(id);
            $('#_mode').val('edit');
        ...
        $('#bank_name').on('change', function() {
            ...
            $.ajax({
                ...
                success: function(r) {
                    if (r.status == '200') {
                        swal('Brand',
                            'Nama bank sudah ada disistem, silahkan ganti dengan yang lain',
                            'warning');
                        $('#bank_name').val('');
                        return false;
                    }
