...
@section('content')
    ...
    <style>
        ...
        .table-responsive {
            ...
            border-radius: 8px;
            overflow-y: auto;
            max-width: 80%; /* Ubah ini agar tabel dapat menyesuaikan lebar layar */
            white-space: nowrap;
            border-radius: 30px;
        }
        ...
        @media (max-width: 768px) {
            ...
            .table-responsive {
                padding: 10px; /* Mengurangi padding di layar kecil */
                max-width: 100%; /* Membuat tabel menyesuaikan lebar layar */
                overflow-x: auto; /* Tambahkan ini untuk menghindari horizontal scroll */
            }
    
            .table-header th,
            tbody td {
                padding: 8px; /* Kurangi padding di layar kecil */
...
@media (max-width: 360px) {
    ...
    .btn-date-info,
    .btn-dark {
        padding: 5px 10px; /* Kurangi padding di tombol */
        font-size: 10px; /* Kecilkan ukuran font */
    }

    .table-responsive {
        padding: 1px; /* Mengurangi padding di layar kecil */
        max-width: 100%; /* Pastikan tabel menyesuaikan lebar layar */
        overflow-x: auto; /* Tambahkan ini untuk menghindari horizontal scroll */
    }

    .table {
        width: 100%; /* Buat tabel mengikuti lebar layar */
        font-size: 10px; /* Kecilkan font di tabel */
    }

    .table-header th {
        padding: 5px; /* Kurangi padding di header tabel */
        font-size: 10px; /* Kecilkan ukuran font */
    }

    tbody td {
        padding: 5px; /* Kurangi padding di isi tabel */
        font-size: 10px; /* Kecilkan ukuran font */
    }

    .stock-logo {
        max-width: 80%; /* Kecilkan ukuran logo agar tidak terlalu besar */
        margin-bottom: 10px;
    }

    /* Kurangi margin atau padding yang berlebihan */
    .mb-4.text-center {
        margin-bottom: 3px; /* Mengurangi jarak bawah */
    }
}
