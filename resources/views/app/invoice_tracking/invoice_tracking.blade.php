                ...
                <div class="col-lg-12 col-xxl-12">
                    ...
                    <div class="card card-custom gutter-b">
                        <div class="col-12 row justify-content-between">
                            ...
                            data-toggle="tooltip" title="Select dashboard daterange" data-placement="left" style="cursor:pointer;">
                        ...
                        <div class="card-body table-responsive">
                            ...
                            <input type="search" class="form-control  col-6" id="invoice_tracking_search"
                                placeholder="Cari invoice / nomor resi / customer (ketik minimal 4 karakter)" /><br />
