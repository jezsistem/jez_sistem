<script>
    ...
    $(document).ready(function () {
        ...
        var stock_data_table_two = $('#StockDatatb').DataTable({
            destroy: true,
            processing: false,
            serverSide: true,
            responsive: false,
            ...
            ajax: {
                url: "{{ url('stock_data_datatables_two') }}",
                data: function (d) {
        ...
        var oSettings = stock_data_table_two.settings();
        // }
        ...
        stock_data_table_two.buttons().container().appendTo($('#stock_data_excel_btn'));
        // $(document).ready(function () {
