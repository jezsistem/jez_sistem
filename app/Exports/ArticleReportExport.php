...
class ArticleReportExport implements FromCollection, withHeadings
{
    ...
    public function collection()
    {
        ...
        if ($this->type == 'article') {
            $data = DB::table('pos_transaction_details')->select('pos_transaction_details.id as ptd_id', 'st_name',  'pos_order_number', 'pos_transaction_details.created_at as ptd_created', 'pos_transaction_details.pst_id as pst_id', 'pos_invoice', 'cross_order', 'u_name',
