...
class SalesReportController extends Controller
{
    ...
    public function getDatatables(Request $request)
    {
        if (request()->ajax()) {
            return datatables()->of(PosTransactionDetail::select(
                ...
                ->Join('product_location_setup_transactions', 'product_location_setup_transactions.pt_id', '=', 'pos_transactions.id')
                ->Join('products', 'products.id', '=', 'product_stocks.p_id')
                ->Join('product_categories', 'products.pc_id', '=', 'product_categories.id')
                ->Join('product_sub_categories', 'products.psc_id', '=', 'product_sub_categories.id')
                ->Join('product_sub_sub_categories', 'products.pssc_id', '=', 'product_sub_sub_categories.id')
                ...
                ->Join('store_type_divisions', 'store_type_divisions.id', '=', 'pos_transactions.std_id')
                ->Join('purchase_order_article_details', 'purchase_order_article_details.pst_id', '=', 'product_stocks.id')
                ->Join('purchase_order_article_detail_statuses', 'purchase_order_article_detail_statuses.poad_id', '=', 'purchase_order_article_details.id')
    ...
    public function hbhjDatatables(Request $request)
    {
        if (request()->ajax()) {
            return datatables()->of(DB::table('product_stocks')
                ->selectRaw("ts_product_stocks.id as id, br_name, p_name, p_color, sz_name, psc_name, 
