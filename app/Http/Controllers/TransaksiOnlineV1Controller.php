...
class TransaksiOnlineV1Controller extends Controller
{
    ...
    public function index()
    {
        ...
        return view('app.online_transaction_v1.online_transaction_v2', compact('data'));
    }
