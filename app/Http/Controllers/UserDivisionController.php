        ...
        if(request()->ajax()) {
            ...
            return datatables()->of($query)
                ...
                ->addColumn('action', function($row){
                    ...
                    $btn .= '<a href="'.route('user-divisions.show', $row->id).'" class="btn btn-info btn-xs" title="View"><i class="ki-outline ki-eye"></i></a>';
                    $btn .= '<a href="'.route('user-divisions.edit', $row->id).'" class="btn btn-warning btn-xs" title="Edit"><i class="ki-outline ki-notepad-edit"></i></a>';
                    $btn .= '<button type="button" class="btn btn-danger btn-xs" onclick="deleteUserDivision('.$row->id.')" title="Delete"><i class="ki-outline ki-trash-square"></i></button>';
                    $btn .= '</div>';
                    return $btn;
                })
