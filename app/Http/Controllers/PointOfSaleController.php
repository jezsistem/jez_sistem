        ...
        if ($request->get('query')) {
            ...
            if (!empty($data)) {
                foreach ($data as $row) {
                    ...
                    $output .= '
                    <li>
                    <a class="btn btn-sm btn-inventory col-12" data-b1g1_id="' . $b1g1_id . '" data-b1g1_price="' . $b1g1_price . '" data-fs="' . $fs . '" data-psc_id="' . $row->psc_id . '" data-pls_qty="' . $row->pls_qty . '" data-plst_id="' . $row->plst_id . '" data-pl_id="' . $row->pl_id . '" data-sell_price="' . $sell_price . '" data-sell_price_discount="' . $sell_price_discount . '" data-bandrol="' . $bandrol . '" data-ps_qty="' . $row->ps_qty . '" data-pst_id="' . $row->pst_id . '" data-p_name="'.$row->article_id . ' ' . $row->br_name . ' ' . $row->p_name . ' - ' . $row->p_color . ' [' . $row->sz_name . '] [' . $row->pl_code . ']" id="add_to_item_list">
