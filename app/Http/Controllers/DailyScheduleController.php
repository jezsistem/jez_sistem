...
class DailyScheduleController extends Controller
{
    ...
    private function generateMonthlyReportHTML($users, $groupedSchedules, $startDate, $endDate)
    {
        ...
        <head>
            ...
            /* Full & Full Shift 0 */
            .shift-FSE { background-color: #e6ffe5; color: #333; } /* Full Shift - Light Yellow */
            .shift-FM2 { background-color: #e6ffe5; color: #333; } /* Full Morning 2 - Light Yellow */
            .shift-FM1 { background-color: #e5f7ff; color: #333; } /* Full Morning 1 - Light Yellow */
            ...
            /* Part Shifts */
            .shift-SM2 { background-color: #e6ffe5; color: #333; } /* Shift Morning 2 - Light Blue */
            ...
            .shift-PS1 { background-color: #e5f7ff; color: #333; } /* Part Shift 1 - Light Green */
            .shift-PS0 { background-color: #e5f7ff; color: #333; } /* Part Shift 0 - Light Green */
            .shift-PL2 { background-color: #e6ffe5; color: #333; } /* Part Libur 2 - Shift 1 (Light Blue) */
    ...
    private function detectFilterFromDateRange($startDate, $endDate)
    {
        ...
        // Compare date ranges
        if (
            $start->format('Y-m-d') === $mondayThisWeek->format('Y-m-d') &&
            $end->format('Y-m-d') === $mondayThisWeek->copy()->endOfWeek()->format('Y-m-d')
        ) {
            return 'this_week';
        } elseif (
            $start->format('Y-m-d') === $mondayNextWeek->format('Y-m-d') &&
            $end->format('Y-m-d') === $mondayNextWeek->copy()->endOfWeek()->format('Y-m-d')
        ) {
            return 'next_week';
        } elseif (
            $start->format('Y-m-d') === $mondayLastWeek->format('Y-m-d') &&
