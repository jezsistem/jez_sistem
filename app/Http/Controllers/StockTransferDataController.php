            ...
            return datatables()->of(StockTransferDetail::select(
                ...
                ->editColumn('accept', function ($data) {
                    ...
                    if ($accept_qty < $data->stfd_qty) {
                        ...
                        return '<input class="form-control accept_qty" data-stfd_id="' . $data->stfd_id . '" data-pst_id="' . $data->pst_id . '" data-ps_barcode="' . $data->ps_barcode . '" data-pl_id="' . $data->pl_id . '" data-stfd_qty="' . $current_qty_accept . '" value="' . $temp_quantity . '" id="accept_qty" type="number">';
                    } else {
